...
<!--                        &nbsp; --><?php //echo __('Output in', true); ?><!-- &nbsp;-->
                        ...
                        <td colspan="5" class="value">
                            <table class="in-date"><tbody>
                                <tr>
                                    ...
                                    <td><input type="hidden" id="query-start_time-wDt" onchange="setPeriod('custom')" onkeydown="setPeriod('custom')"
                                               readonly="readonly"
                                               style="width: 60px;" value="00:00:00" name="start_time" class="input in-text"></td>
                                    <td>&mdash;</td>
                                    <td><table class="in-date">
                                            <tbody><tr>
                                                <td><input type="text" id="query-stop_date-wDt" class="wdate in-text input"  style="width: 156px;"    onchange="setPeriod('custom')"
                                                           readonly="readonly"
                                    ...
                                    <td><input type="hidden" id="query-stop_time-wDt" onchange="setPeriod('custom')"
                                               readonly="readonly"
                ...
                <table class="form table dynamicTable tableTools table-bordered  table-white">
                    ...
                    <tr>
                        ...
                        <td class="right" style="border-bottom: 1px solid #EFEFEF;"></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul>
                                ...
                                <li>
                                     <input type="checkbox" name="is_invoice_account_summary" />
                                    <?php __('Include Breakout Summary')?>
                                      <select name="invoice_use_balance_type" style="width:150px; display:none;" disabled>
                                             <option value=0>Use actual balance</option>
                                             <option value=1>Use manual balance</option>
                                     </select>
                                </li>
                                <li>
                                    <input type="checkbox" name="show_account_summary" />
                                    <?php __('Show Account Summary')?>
                                </li>
                            </ul>
                        </td>
                    </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('input[name="is_invoice_account_summary"]').on('click', function(){
            if($(this).is(':checked')){
                $('select[name="invoice_use_balance_type"]').attr('disabled', false).show();
            }else{
                $('select[name="invoice_use_balance_type"]').attr('disabled', true).hide();
            }
        });
