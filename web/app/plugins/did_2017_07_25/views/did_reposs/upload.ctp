...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Vendor DID Repository') ?></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
...
<div class="buttons pull-right newpadding">
        <a  class="btn btn-icon btn-inverse glyphicons circle_arrow_left" href="<?php echo $this->webroot ?>did/did_reposs"><i></i>
            <?php __('Back')?>
        </a>
    </div>
                ...
                <form id="myform" method="post"  enctype="multipart/form-data">
                    <table class="table dynamicTable tableTools table-bordered  table-white form">
                        <tbody>
                            ...
                            <!--<tr>
                                <th style="text-align:right;"><?php __('Ingress Trunk'); ?></th>
                                <td>
                                    <?php if(isset($client_id)): ?>
                                    <span ><?php echo $ingresses[$client_id] ?></span>
                                    <?php  else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="<?php echo $this->webroot; ?>example/did_number.csv"><?php __('show')?></a>
                                </td>
                            </tr>
