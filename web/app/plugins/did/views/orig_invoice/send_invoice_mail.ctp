<div class="row-fluid">
    <form class="form-horizontal" id="send_email_id" method="post" action="<?php echo $this->webroot ?>did/orig_invoice/resend/<?php echo $this->params['pass'][0]?>/<?php echo $this->params['pass'][1]; ?>">
