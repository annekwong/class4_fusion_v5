...
<ul class="breadcrumb">
    ...
    <li><a href="<?= $this->webroot?>did/log/index"><?php __('Log') ?></a></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?= $this->webroot?>did/log/index"><?php echo __('Origination Log', true); ?></a></li>
</ul>

<div class="heading-buttons">
    <h4 class="heading"><?php echo __('Origination Log', true); ?></h4>
