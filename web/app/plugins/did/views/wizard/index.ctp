...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->webroot ?>did/wizard"><?php __('Origination') ?></a></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?php echo $this->webroot ?>did/wizard"><?php echo __('Wizard') ?></a></li>
</ul>
        ...
        <div class="widget-body">
            <form method="post" id="wizard_form" >
                <div class="tab-content">
                    ...
                    <!--step 1-->
                    <div id="tab1-2" class="tab-pane active" style="height:100%; min-height:600px;">
                    ...
                    <!--step 2-->
                    <div id="tab2-2" class="tab-pane" style="min-height:850px;">
                        <table class="form table dynamicTable tableTools table-bordered  table-white">
                            <col width="40%">
                            <col width="60%">
                            <tr>
...
//            
        ...
        $("#upload_did").click(function() {
            ...
            window.open("<?php echo $this->webroot; ?>did/did/upload");
        });
                        ...
                        $dd_vendor.dialog({
                            ...
                            'width': '850px',
                             open: function( event, ui ) {
                               $dd_vendor.closest("div[role='dialog']").css({top:75});
                              },
                            buttons: [{
                                    text: 'Submit',
                                    class: 'btn btn-primary',
                                    click: function() {
                                        ...
                                        if(!$('#vendor_name').val().trim()){
                                            jGrowl_to_notyfy('<?php __('Vendor Name is required!'); ?>', {theme: 'jmsg-error'});
                                            return false;
                                        }
                            ...
                            buttons: [{
                                    ...
                                    click: function() {
                                        $.ajax({
                                            ...
                                            success: function(data) {
                                                if(!$('#myform_client #vendor_name').val().trim()){
                                                    jGrowl_to_notyfy('<?php __('Client Name	is required!'); ?>', {theme: 'jmsg-error'});
                                                    return false;
                                                }
                                                if (data == 1)
                                                {
