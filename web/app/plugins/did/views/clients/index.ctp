                    ...
                    <table class="footable table table-striped tableTools table-bordered  table-white table-primary table_page_num" id="key_list" >
                        ...
                        for ($i = 0; $i < $count; $i++):
                            ...
                            <tr class="row-<?php echo $i % 2 + 1; ?>">
                                <td>
                                    <input type="checkbox" class="multi_select" value="<?php echo $this->data[$i]['Client']['client_id']; ?>">
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php
                                    $balance = isset($this->data[$i]['Balance']['balance']) ? $this->data[$i]['Balance']['balance'] : 0;
                                    echo number_format($balance, 3); ?>
                                </td>
                                <td>
                                    <?php
                                ...
                                <td><?php echo isset($this->data[$i]['Resource']['price_per_max_channel']) ? number_format($this->data[$i]['Resource']['price_per_max_channel'], 3) : "0.000"; ?></td>
                                ...
                                <td>
                                    ...
                                    {
                                        ?>
                                        <a  title=" <?php __('Click to inactive client'); ?>" onclick="return myconfirm('Are you sure to inactive the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)"   href="<?php echo $this->webroot ?>did/clients/disable/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>" > <i class="icon-check"></i> </a>
                                        <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <a title=" <?php __('Click to active client'); ?>" onclick="return myconfirm('Are you sure to active the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)" href="<?php echo $this->webroot ?>did/clients/enable/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>"  > <i class="icon-unchecked"></i> </a>
                                    <?php } ?>
                                    <?php
                                    if ($this->data[$i]['Resource']['active'] == true)
                                    {
                                        ?>
                                        <a  title=" <?php __('Click to inactive client trunks'); ?>" onclick="return myconfirm('Are you sure to inactive trunks for the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)"   href="<?php echo $this->webroot ?>did/clients/disableTrunks/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>" > <i class="icon-check"></i> </a>
                                        <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <a title=" <?php __('Click to active client trunks'); ?>" onclick="return myconfirm('Are you sure to active trunks for the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)" href="<?php echo $this->webroot ?>did/clients/enableTrunks/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>"  > <i class="icon-unchecked"></i> </a>
                                    <?php } ?>

                                    <a href="<?php echo $this->webroot ?>did/repository?orig_client_id=<?php echo $this->data[$i]['Client']['client_id'] ?>&orig_client_name=<?php echo $this->data[$i]['Client']['name'] ?>" title="<?php __('View DID') ?>">
