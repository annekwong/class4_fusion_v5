...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Delete Uploaded') ?></li>
</ul>
<div class="heading-buttons">
    <h4 class="heading"><?php echo __('Delete Uploaded') ?></h4>
                    ...
                    <table class="list table dynamicTable tableTools table-bordered  table-white form">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <a href="<?php echo $example ?>" target="_blank" title="click to download"><?php __('Download')?></a>
                                </td>
                            </tr>
