            ...
            <div id="container">
                <form id="myform" method="post" enctype="multipart/form-data">
                    <table class="table dynamicTable tableTools table-bordered  table-white form">
                        ...
                        <tr>
                            <td class="align_right padding-r20"><?php echo __('Tech Prefix') ?></td>
                            <td>
                                <input type="text" name="tech_prefix" value="<?php echo $client['tech_prefix'] ?>">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="rpid" id="">
                                    <option value="0" <?php echo $client['rpid'] == 0 ? 'selected' : '' ?>>Never</option>
                                    <option value="1" <?php echo $client['rpid'] == 1 ? 'selected' : '' ?>>Pass through</option>
                                    <option value="2" <?php echo $client['rpid'] == 2 ? 'selected' : '' ?>>Always</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="paid" id="">
                                    <option value="0" <?php echo $client['paid'] == 0 ? 'selected' : '' ?>>Never</option>
                                    <option value="1" <?php echo $client['paid'] == 1 ? 'selected' : '' ?>>Pass through</option>
                                    <option value="2" <?php echo $client['paid'] == 2 ? 'selected' : '' ?>>Always</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
