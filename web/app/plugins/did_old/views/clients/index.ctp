...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Clients') ?></li>
</ul>

<div class="heading-buttons">
    <h1><?php __('Clients') ?></h1>
                            ...
                            <tbody id="resInfo<?php echo $i ?>">
                                <tr class="row-<?php echo $i % 2 + 1; ?>">
                                    ...
                                    <td>
                                        ...
                                        <a  onclick="return myconfirm('<?php __('sure to delete'); ?>', this);" href="<?php echo $this->webroot ?>did/clients/delete/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>">
                                        ...
                                        {
                                            ?>
                                            <a  title=" <?php echo __('Click to inactive'); ?>" onclick="return myconfirm('Are you sure to inactive the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)"   href="<?php echo $this->webroot ?>did/clients/disable/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>" > <i class="icon-check"></i> </a>
                                            <?php
                                        }
                                        else
                                        {
                                            ?>
                                            <a title=" <?php echo __('Click to active'); ?>" onclick="return myconfirm('Are you sure to active the selected <?php echo $this->data[$i]['Client']['name'] ?>?', this)" href="<?php echo $this->webroot ?>did/clients/enable/<?php echo base64_encode($this->data[$i]['Client']['client_id']) ?>"  > <i class="icon-unchecked"></i> </a>
                                        <?php } ?>

                                        <a target="_blank" href="<?php echo $this->webroot ?>did/did_assign/index/<?php echo base64_encode($this->data[$i]['Client']['egress_id']) ?>" title="<?php __('View DID') ?>"> 
