...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Special Code') ?></li>
</ul>
    ...
    <?php foreach ($this->data as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="<?php __('Delete') ?>" class="delete" href='<?php echo $this->webroot; ?>did/billing_rule/delete_code/<?php echo base64_encode($item['DidSpecialCode']['id']) ?>'>
