...
<div class="heading-buttons">
    <h4 class=""heading><?php echo __('Request Report') ?></h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['login_type'] == 1 && $current == 'active'): ?>
                                            <a href="<?php echo $this->webroot ?>did/did_request/assign/<?php echo $item['DidRequest']['id']; ?>/<?php echo $current; ?>" title="<?php __('Confirm')?>">
                                                <i class="icon-wrench"></i>
                                            </a>
                                        <?php endif; ?>
                                        <a href="<?php echo $this->webroot ?>did/did_request/email/<?php echo $item['DidRequest']['id']; ?>/<?php echo $current; ?>" title="<?php __('Email Me')?>">
                                            <i class="icon-envelope"></i>
                                        </a>
                                        <a href="<?php echo $this->webroot ?>did/did_request/detail/<?php echo $item['DidRequest']['id']; ?>/<?php echo $current; ?>" title="<?php __('View Details')?>">
