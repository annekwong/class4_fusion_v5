                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['login_type'] == 1): ?>
                                            <a href="<?php echo $this->webroot ?>did/lnp_request/assign/<?php echo $item['LnpRequest']['id']; ?>" title="<?php __('Confirm')?>">
                                                <i class="icon-wrench"></i>
                                            </a>
                                        <?php endif; ?>
                                        <a href="<?php echo $this->webroot ?>did/lnp_request/get_file/<?php echo $item['LnpRequest']['id']; ?>" title="<?php __('Get File')?>">
                                            <i class="icon-download-alt"></i>
                                        </a>
                                        <a href="<?php echo $this->webroot ?>did/lnp_request/detail/<?php echo $item['LnpRequest']['id']; ?>" title="<?php __('View Details')?>">
