...
class LnpRequestController extends DidAppController
{
    ...
    public function assign($request_id)
    {
        ...
        if ($_SESSION['login_type'] == 1) {
            ...
            $this->Session->write('m', $this->LnpRequest->create_json(201, __('The LNP Request #%s is confirmed successfully!', true, $request_id)));
    ...
    public function push()
    {
        ...
        if ($this->RequestHandler->isPost()) {
            ...
            if (is_uploaded_file($_FILES['upload_file']['tmp_name'])) {
                ...
                $this->Session->write('m', $this->LnpRequest->create_json(201, __('The LNP Request #%s is assigned successfully!', true, $request_id)));
                $this->redirect('/did/lnp_request/index/');
            }
        }
    }
