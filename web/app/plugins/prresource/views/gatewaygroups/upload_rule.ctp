...
<div class="heading-buttons">
    <h4 class="heading"><?php __('Upload Fail-over Rule')?></h4>
...
<div class="buttons pull-right newpadding">
    <?php echo $this->element('xback',array('backUrl' => 'prresource/gatewaygroups/add_rule/'.$this->params['pass'][0].'/'.$this->params['pass'][1])); ?>
</div>
<div class="clearfix"></div>
<div class="innerLR">
    ...
    <div class="widget widget-tabs widget-body-white">
        <div class="widget-body">
            <form id="form1" class="form-inline" action="<?php echo $this->webroot ?>uploads/fail_over_rule" method="POST" enctype="multipart/form-data">
                ...
                <table class="cols" style="width:700px;margin:0px auto;">
                    ...
                    <tr><td align="right">Example:</td><td align="left"><a href="<?php echo $this->webroot ?>example/failover_rule.csv" target="_blank" id="show_example" title="Show example file">show</a></td></tr>
                    <tr>
