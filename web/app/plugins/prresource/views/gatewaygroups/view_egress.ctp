...
<ul class="breadcrumb">
    ...
    <?php if (isset($_GET['query']['id_clients'])): ?>
        ...
        <li class="divider"><i class="icon-caret-right"></i></li>
        <li>
            <a href="<?php echo $this->webroot ?>prresource/gatewaygroups/view_egress">
            <?php echo __('Carrier') . ' [' . $c[$_GET['query']['id_clients']] . '] ';?></a></li>
    <?php else:?>
        <li><a href="<?php echo $this->webroot ?>prresource/gatewaygroups/view_egress">
            <?php __('Routing') ?></a></li>
    <?php endif;?>
...
<div class="buttons pull-right newpadding">
    ...
    <?php if ($w == true) { ?>
                <a class="link_btn btn btn-primary btn-icon glyphicons circle_plus" id="add" href="<?php echo $this->webroot ?>prresource/gatewaygroups/add_resouce_egress<?php if (isset($_GET ['query'] ['id_clients'])) {
            echo "?query[id_clients]={$_GET ['query'] ['id_clients']}&viewtype=client";
        } ?>">
    ...
    <?php } ?>
            ...
            <?php if ($loop > 0) : ?>
                <a rel="popup" class="link_btn btn btn-primary btn-icon glyphicons remove" href="javascript:void(0)" onclick="deleteSelected('mytable','<?php echo $this->webroot ?>prresource/gatewaygroups/del_selected?type=view_egress','egress trunk');">
                    <i></i> <?php echo __('deleteselected') ?>
                </a>
    <?php endif; ?>
<?php } ?>
    <?php if (isset($_GET['viewtype']) && $_GET['viewtype'] == 'client') { ?>
            <a  class="link_back btn btn-icon btn-inverse glyphicons circle_arrow_left" href="<?php echo $this->webroot ?>clients/index" class="link_back">
                <i></i> <?php echo __('goback', true); ?></a>
        <?php } ?>  
    </div>
        ...
        <div class="widget-head">
            <ul>
                ...
                <li><a class="glyphicons coffe_cup" href="<?php echo $this->webroot ?>clients/edit/<?php echo base64_encode($_GET ['query'] ['id_clients']) ?>?<?php echo $this->params['getUrl'] ?>"><i></i> <?php __('basicinfo') ?></a></li>   
                    <li class="active"><a class="glyphicons right_arrow"  href="###" onclick="javascript:(window.location.href= $(this).attr('url'));" url="<?php echo $this->webroot ?>prresource/gatewaygroups/view_egress?<?php echo $this->params['getUrl'] ?>?>&viewtype=client"><i></i> <?php __('egress') ?></a></li> 
                    <li><a class="glyphicons left_arrow"  href="###" onclick="javascript:(window.location.href= $(this).attr('url'));" url="<?php echo $this->webroot ?>prresource/gatewaygroups/view_ingress?<?php echo $this->params['getUrl'] ?>?>&viewtype=client"><i></i><?php __('ingress') ?></a></li> 
                <?php } else { ?>
                    <li class="active"><a class="glyphicons right_arrow"  href="###" onclick="javascript:(window.location.href= $(this).attr('url'));" url="<?php echo $this->webroot ?>prresource/gatewaygroups/view_ingress?<?php echo $this->params['getUrl'] ?>"><i></i> <?php __('egress') ?></a></li>
                    <li  ><a class="glyphicons left_arrow"  href="###" onclick="javascript:(window.location.href= $(this).attr('url'));" url="<?php echo $this->webroot ?>prresource/gatewaygroups/view_ingress"><i></i><?php __('ingress') ?></a></li> 
<?php } ?>
            </ul>
        </div>
...
?>"  onclick="this.value=''" name="search">
            ...
            <div>
                <div class="tabsbar">
                    <ul class="tabs">
                            <li class="hover glyphicons list active"><a hit="" onclick="second_tab_change('list',this)" href="#"><i></i><?php __('Egress List')?></a></li> 
                            <?php if ($_SESSION['role_menu']['Routing']['gatewaygroups:view']['model_x']) { ?>
                            <li class="glyphicons no-js file_import"><a hit="myfile" show_type="11" onclick="second_tab_change('egress_import',this)" href="#<?php echo $this->webroot ?>uploads/egress"><i></i><?php echo __('Egress Import', true); ?></a></li>
                            <li class="glyphicons no-js file_export"><a hit="" onclick="second_tab_change('egress_export',this)" href="#<?php echo $this->webroot ?>downloads/egress"><i></i><?php echo __('Egress Export', true); ?></a></li>
                            <li class="glyphicons no-js file_import"><a hit="myfile2" show_type="9" onclick="second_tab_change('egress_import_host',this)" href="#<?php echo $this->webroot ?>uploads/egress_host"><i></i> <?php echo __('Import Host', true); ?></a></li> 
                            <li class="glyphicons no-js file_export"><a hit="" onclick="second_tab_change('egress_export_host',this)" href="#<?php echo $this->webroot ?>downloads/egress_host"><i></i> <?php echo __('Export Host', true); ?></a></li>   
                            <li class="glyphicons no-js file_import"><a hit="myfile3" show_type="8" onclick="second_tab_change('egress_import_action',this)" href="#<?php echo $this->webroot ?>uploads/egress_action"><i></i> <?php echo __('Import Action', true); ?></a></li> 
                            <li class="glyphicons no-js file_export"><a onclick="second_tab_change('egress_export_action',this)" href="#<?php echo $this->webroot ?>downloads/egress_action"><i></i> <?php echo __('Export Action', true); ?></a></li>
                        <?php } ?>  
                    </ul>
                </div>
...
<script type="text/javascript">
    jQuery('#list').show();
    var $ckb = [];
    var $form = $('#egress_export').find('form');
