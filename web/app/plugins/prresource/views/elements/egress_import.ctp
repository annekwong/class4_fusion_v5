<form id="form1" class="form-inline" action="<?php echo $this->webroot?>uploads/egress" method="POST" enctype="multipart/form-data">
...
<!--					<input type="radio" name="duplicate_type" value="overwrite" id="duplicate_type_overwrite">
					...
					<label for="duplicate_type_delete"><?php echo __('delete',true);?></label>
                        ...
                        <tr><td align="right"><?php __('Example')?>:</td><td align="left"><a href="<?php echo $this->webroot?>example/egress.csv" target="_blank" title="Show example file"><?php __('show')?></a></td></tr>
			<tr>
