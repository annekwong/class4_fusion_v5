...
<form id="form1" class="form-inline" action="<?php echo $this->webroot?>uploads/ingress" method="POST" enctype="multipart/form-data">
...
<table class="cols" style="width: 252px; margin: 0px auto;"></table>
	...
	<tbody><tr>
		...
		<td style="text-align:left;" class="last"><input type="file" name="file" id="myfile" class=""></td>
	</tr>
	<tr>
...
<!--			<input type="radio" name="duplicate_type" value="overwrite" id="duplicate_type_overwrite" class="">
        ...
        <tr><td align="right"><?php __('Example')?>:</td><td align="left"><a href="<?php echo $this->webroot?>example/ingress.csv" target="_blank" title="Show example file"><?php __('show')?></a></td></tr>
	<tr>
