...
<form id="form4" class="form-inline" action="<?php echo $this->webroot ?>uploads/ingress_tran" method="POST" enctype="multipart/form-data">
    ...
    <table class="cols" style="width:700px;margin:0px auto;">
        <tbody><tr>
                ...
                <td style="text-align:left;" class="last"><input type="file" name="file" id="myfile4"></td>
            </tr>
            <tr>
...
<!--			<input type="radio" name="duplicate_type" value="overwrite" id="duplicate_type_overwrite">
            ...
            <tr><td colspan="2"  align="center"><span id="analysis_myfile4" class="analysis" style="display:block;"></span></td></tr>
            <tr><td align="right"><?php __('Example')?>:</td><td align="left"><a href="<?php echo $this->webroot ?>example/resource_digit_mapping.csv" target="_blank" title="Show example file"><?php __('show')?></a></td></tr>
            <tr>
...
<script type="text/javascript">
    $(function() {
        $("#form4").submit(function() {
            var file = $("#myfile4_completedMessage").html();
