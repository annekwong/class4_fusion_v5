        ...
        if ($this->protocol == 'mail') {
            ...
            if (!$handle) {
                ...
                if (!empty($this->username)  && !empty($this->password)) {
                    $env =  $this->hostname ? : getenv('SERVER_NAME') ;
                    fputs($handle, 'EHLO ' . $env . $this->crlf);
                    ...
                    $env = $this->servername ? : getenv('SERVER_NAME') ;
                ...
                if($this->cc) {
                    if (!is_array($this->cc)) {
                        fputs($handle, 'RCPT TO: <' . $this->cc . '>' . $this->crlf);
