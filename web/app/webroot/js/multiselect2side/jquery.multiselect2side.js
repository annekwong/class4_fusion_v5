...
(function($)
{
	jQuery.fn.multiselect2side = function (o) {
		...
		return this.each(function () {
			...
			//			"<p class='SelSort btn-link' title='Sort'>" + o.labelSort + "</p>" +
			//			"<p class='MoveTop  btn-link' title='Move on top selected option'>" + o.labelTop + "</p>" +
			//			"<p class='MoveUp  btn-link' title='Move up selected option'>" + o.labelUp + "</p>" +
			//			"<p class='MoveDown  btn-link' title='Move down selected option'>" + o.labelDown + "</p>" +
			//			"<p class='MoveBottom  btn-link' title='Move on bottom selected option'>" + o.labelBottom + "</p>" +
			//		"</div>";

			var divUpDown =
				"<div class='ms2side__updown'>" +"<br>"+
				"<input type='button' class='SelSort btn ms2side_input' title='Sort' value='" + o.labelSort + "' /><br />" +
				"<input type='button' class='MoveTop btn ms2side_input' title='Sort' value='" + o.labelTop + "' /><br />" +
				"<input type='button' class='MoveUp btn ms2side_input' title='Sort' value='" + o.labelUp + "' /><br />" +
				"<input type='button' class='MoveDown btn ms2side_input' title='Sort' value='" + o.labelDown + "' /><br />" +
				"<input type='button' class='MoveBottom btn ms2side_input' title='Sort' value='" + o.labelBottom + "' />" +
				"</div>";
			...
			var htmlToAdd = 
				"<div class='ms2side__div'>" +
					...
					"<div class='ms2side__options'>" +
						...
						?
						("<br><div class='AddOne btn primary' title='Add Selected'>&rsaquo;</div><br>" +
						"<div class='AddAll btn primary' title='Add All'>&raquo;</div><br>" +
						"<div class='RemoveOne btn primary' title='Remove Selected'>&lsaquo;</div><br>" +
						"<div class='RemoveAll btn primary' title='Remove All'>&laquo;</div><br>")
						:
						("<div class='AddOne btn primary' title='Add Selected'>&lsaquo;</div><br>" +
						"<div class='AddAll btn primary' title='Add All'>&laquo;</div><br>" +
						"<div class='RemoveOne btn primary' title='Remove Selected'>&rsaquo;</div><br>" +
						"<div class='RemoveAll btn primary' title='Remove All'>&raquo;</div><br>")
						) +
					"</div>" +
					"<div class='ms2side__select'>" +
						(o.labeldx ? ("<div class='ms2side__header'>" + o.labeldx + "</div>") : "") +
						"<select title='" + o.labeldx + "' name='" + nameDx + "' id='" + nameDx + "' class='"+ o.selectedClass +"' size='" + size + "' multiple='multiple' ></select>" +
					"</div>" +
					((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
				"</div>";
