...
{
	updatePrimaryColor(primary, false, false);
}
...
function generateCSS(basePath)
{
	...
	var css =
		...
		primaryBackgroundColorImportantTargets.join(", \n") + "\n" +
		"{\n" +
...
[
    ...
    "ul#page_row li:hover",
	"body .window",
	".btn-primary",
	"#flotTip",
	".btn-group.open .btn-primary.dropdown-toggle, .btn-primary.disabled, .btn-primary[disabled], .btn-primary:hover, .btn-default:hover",
	".label-primary",
	...
	".layout-timeline ul.timeline > li.active .type:before, .layout-timeline ul.timeline > li.active .type:after, .innerAll .dropdown-menu > li:hover",
...
var primaryBackgroundColorImportantTargets =
[
	".background-primary"
]
...
[
	...
	"blockquote small",
	".glyphicons.primary i:before, .glyphicons.standard:not(.disabled):hover i:before, .tabsbar.tabsbar-2 ul li.active a i::before, .tabsbar.tabsbar-2 ul li.active a",
