...
},plugins:["linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialogui"],parse:function(_168){
var aa=[];
...
$.fn.dialogui=function(_1f9,_1fa){
if(typeof _1f9=="string"){
var _1fb=$.fn.dialogui.methods[_1f9];
if(_1fb){
...
$.data(this,"dialog",{options:$.extend({},$.fn.dialogui.defaults,$.fn.dialogui.parseOptions(this),_1f9),contentPanel:_1e8(this)});
}
_1eb(this);
});
};
...
$.fn.dialogui.parseOptions=function(_200){
var t=$(_200);
