...
$.fn.dialogui=function(_15,_16){
if(typeof _15=="string"){
var _17=$.fn.dialogui.methods[_15];
if(_17){
return _17(this,_16);
}else{
...
$.data(this,"dialog",{options:$.extend({},$.fn.dialogui.defaults,$.fn.dialogui.parseOptions(this),_15),contentPanel:_1(this)});
}
_4(this);
});
};
$.fn.dialogui.methods={options:function(jq){
...
$.fn.dialogui.parseOptions=function(_1d){
var t=$(_1d);
return $.extend({},$.fn.window.parseOptions(_1d),{toolbar:t.attr("toolbar"),buttons:t.attr("buttons")});
};
$.fn.dialogui.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
