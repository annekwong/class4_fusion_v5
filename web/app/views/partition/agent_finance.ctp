 ...
 <ul id="title-search">
        <form method="get" id="myform1">
            ...
            <li>
                ...
                <li> 
                    <span style="float:left; height:25px; line-height:25px; font-size:14px; color:#EEEEEE; font-weight:bold;"><?php __('Serail Number')?>:</span>
...
<div id="container">
    ...
    <table class="list" id="key_list" >
        <thead>
            ...
            <tr>
                <td><?php __('Serail Number')?></td>
                <td><?php __('Method')?></td>
                <td><?php __('Amount')?></td>
                <td><?php __('Actual Amount')?></td>
                <td><?php __('Fee')?></td>
                <td><?php __('Transaction Date')?></td>
                <td><?php __('Status')?></td>
                <td><?php __('Completed Date')?></td>
                <td class="last"><?php __('Action')?></td>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="last">
                    ...
                    <a title="more"href="javascript:void(0);" onclick="get_more_message(this,'<?php echo $item[0]['id']?>');" ><?php __('more')?></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
