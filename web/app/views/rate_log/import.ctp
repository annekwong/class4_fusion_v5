                    ...
                    <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary">
                        ...
                        <?php foreach ($this->data as $item): ?>
                            <tr>
                                ...
                                <td><?php echo isset($method[$item['RateUploadTask']['reduplicate_rate_action']]) ? $method[$item['RateUploadTask']['reduplicate_rate_action']] : '--'; ?></td>
                                <td>
                                    <?php if (strcmp('1', $item['RateUploadTask']['status']) && strcmp('-1', $item['RateUploadTask']['status']) && $item['RateUploadTask']['start_time']){
                                ...
                                <td data-hide="phone,tablet" class="footable-last-column"  style="display: table-cell;">
                                    ...
                                    <a target="_blank" title="<?php __('Uploaded File') ?>" href="<?php echo $this->webroot; ?>rate_log/get_file/?file=<?php echo base64_encode($item['RateUploadTask']['upload_file_path'] . DS .$item['RateUploadTask']['upload_format_file']); ?>">
