...
<div class="innerLR">
    ...
    <div class="widget widget-tabs widget-body-white">
        <?php echo $this->element("currs/step", array('now' => '2')); ?>
        <div class="widget-body uniformjs collapse in" style="min-height: 100px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label class="radio">
                            ...
                            <?php __('System Default File'); ?>
                        </label>
                    </td>
                </tr>
            </table>
            <form action="<?php echo $this->webroot; ?>necessary_configuration/codes_deck_default/<?php echo $code_deck_info['Codedeck']['code_deck_id'] ?>" method="post" id="myform">
                <div class="row-fluid hide" id="default_content">
                    <div class="span3">
                    </div>
                    <div class="span9">
                        <div class="widget-body uniformjs">
                            <label class="radio">
                                <input type="radio" class="radio" name="default_file_type" value="1" checked="checked" />
                                <?php __('Use Default A-Z Code Deck'); ?>
                                <a href="<?php echo $this->webroot ?>example/default_code_deck/a-z.csv" target="_blank" title="Download"><i class="icon-download"></i></a>
                            </label><br/>
                            <label class="radio">
                                <input type="radio" class="radio" name="default_file_type" value="2"  />
                                <?php __('Use Default US Code Deck with State as Code Name'); ?>
                                <a href="<?php echo $this->webroot ?>example/default_code_deck/us.csv" target="_blank" title="Download"><i class="icon-download"></i></a>
                            </label><br/>
                            <label class="radio">
                                <input type="radio" class="radio disabled" name="default_file_type" value="3"  />
                                <?php __('Use Default US Code Deck with OCN as Code Name'); ?>
                                <a href="<?php echo $this->webroot ?>example/default_code_deck/ocn_lata.csv" title="Download"><i class="icon-download"></i></a>
                            </label>
                        </div>
                    </div>
                    <div class="span4">
            ...
            <form id="improt_form" action="<?php echo $this->webroot; ?>necessary_configuration/codes_deck/<?php echo $code_deck_info['Codedeck']['code_deck_id'] ?>/<?php echo $user_id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row-fluid widget-body" id="custom_content">
                    ...
                    <div class="span8 offset3">
                        <table class="cols margin-none" >
                            ...
                            <tr><td align="right"><?php __('Example') ?>:</td><td align="left"><a href="<?php echo $this->webroot ?>example/<?php echo $example_file ?>.csv" target="_blank"><?php __('show') ?></a></td></tr>
                        </table>
                    </div>
                    <div class="span4">
                    </div>
...
//        $("div.navbar").hide();
        $.gritter.add({
            title: '<?php __('Setup Code Decks'); ?>',
            text: '<?php __('You may use our default code deck for A-Z , United States, and US OCN-Lata termination, or you may upload your own.'); ?>',
            sticky: true
        });
        ...
        $("#myfile").makeAsyncUploader({
            ...
            upload_success_handler: function (file, response) {
                ...
                $("#analysis").html('<a target="_blank" href="<?php echo $this->webroot; ?>uploads/analysis_file/4/' + response + '">Show and modify</a>');
