...
<table width='100%' cellspacing=0 cellpadding=0>
	<tr>
		...
		<ul id="menufivelist" class='monitor16'>
			<li class='monitor17'><?php __('Simple Moving Average')?> &nbsp;&nbsp;&nbsp;&nbsp;<!--  <img src='images/rights.gif' class='picSMV1'
...
<div id="leftControlBar" class='monitor19'><span class='monitor20'><?php __('View')?>:</span>
<input type='hidden' id='currentView1' value='call1,cps1'> <input
	...
	id="call1" />&nbsp;&nbsp;<?php __('Calls')?><input type="hidden" name="call_1"
	id="call_1" value="0"></input></span> <span class='monitor21'><input
	type='checkbox' checked class='monitor22' onclick='onlychoosetwo(this)'
	id="cps1" />&nbsp;&nbsp;<?php __('CPS')?><input type="hidden" name="cps_1_m"
	...
	onclick='onlychoosetwo(this)' id="asr1" />&nbsp;&nbsp;<?php __('ASR')?><input
...
<table width='100%' cellspacing=0 cellpadding=0>
	<tr>
		...
		<td style="border:1px solid gray;background:#eeeeee;" class='monitor8'><span class="spanStyle2"><?php __('Quality Metrics')?></span> <span
		...
		<ul id="menufivelists" class='monitor16'>
			<li><?php __('Simple Moving Average')?> &nbsp;&nbsp;<img src='images/rights.gif'
...
<div id="rightControlBar" class='monitor19'><span class='monitor20'><?php __('View')?>:</span>
<input type='hidden' id='currentView2' value='asr2,acd2'> <input
	...
	class='monitor21'><input type='checkbox' disabled class='monitor22'
	onclick='onlychoosetwo(this)' id="cps2" />&nbsp;&nbsp;<?php __('CPS')?><input
...
<table id="show_table" cellspacing=0 cellpadding=0 width="100%">
	<thead>
		...
		<tr height="28" bgcolor="#eeeeee">
			<td width="200px" class="bcess_td monitor47"><?php __('Prefix Route Name')?>:</td>
			...
			<td class="bcess_td">
			<div class=" monitor_product_style_10"><?php __('ACD')?></div>
			<div class=" monitor_product_style_11"><?php __('ASR')?></div>
			<div class=" monitor_product_style_11"><?php __('CA')?></div>
			<div class=" monitor_product_style_12"><?php __('PDD')?></div>
			</td>
			<td class="bcess_td">
			<div class=" monitor_product_style_13"><?php __('ACD')?></div>
			<div class=" monitor_product_style_11"><?php __('ASR')?></div>
			<div class=" monitor_product_style_11"><?php __('CA')?></div>
			<div class=" monitor_product_style_12"><?php __('PDD')?></div>
			</td>
			...
			<div class=" monitor_product_style_11"><?php __('ASR')?></div>
			<div class=" monitor_product_style_11"><?php __('CA')?></div>
			<div class=" monitor_product_style_18"><?php __('PDD')?></div>
			</td>
		</tr>
	</thead>
