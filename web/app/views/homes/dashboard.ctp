...
<div class="heading-buttons">
    <h4 class="heading"><?php echo __('Dashboard'); ?></h4>
...
<!--                </li>-->
        ...
        <div class="widget-body">
            ...
            <div class="row-fluid margin-bottom10" style="border: 1px solid #efefef">
                ...
                <div class="span2" style="margin: 0;width: 14.2857142857%">
                    ...
                    <a href="" onclick="return false" class="widget-stats widget-stats-gray widget-stats-2 widget-stats-easy-pie txt">
                        ...
                        <span class="txt" style="font-size: 13px;color: #e5412d;">
                            <?php __('MAX'); ?>: <span id="max_channel"><img src='<?php echo $this->webroot?>images/check_waiting.gif' /></span>
                        </span>
                ...
                <div class="span2" style="margin: 0;width: 14.2857142857%">
                    ...
                    <a href="" onclick="return false" class="widget-stats widget-stats-gray widget-stats-2 widget-stats-easy-pie txt"
                       style="background-color: #ffffff">
                        ...
                        <div id="easy_pie" value="" channel="0"
                             cps="0" data-percent="0" class="easy-pie primary"><span class="value" style="color: #7faf00"></span></div>
                        <span class="txt" style="font-size: 13px;color: #e5412d;">
                            <?php __('MAX'); ?>: <span class="txt-single" id="max_cps"><img src='<?php echo $this->webroot?>images/check_waiting.gif' /></span>
                        </span>
                ...
                <div class="span2" style="margin: 0;width: 14.2857142857%">
                    <a href="" onclick="return false" class="widget-stats widget-stats-4">
                        <span class="txt text-center"><?php __('Total Calls'); ?></span>
                        <span class="count txt-single text-center" id="call_value"
                              style="font-size: 20px;width: 100%">0</span>
                        <!--<span class="glyphicons phone"><i></i></span>-->
                        <div class="clearfix"></div>
                    </a>
...
<!--                    <li value="3">--><?php //__('Last 7 Days') ?><!--</li>-->
            ...
            <div class="row-fluid margin-bottom10" style="border: 1px solid #efefef">
                <div class="span3">
                    <a href="#" onclick="return false" class="widget-stats widget-stats-4">
                        <span id="asr_title" class="txt text-center"><?php __('Last Hour ASR in '); ?></span>
            ...
            <div class="bottom row-fluid">
                <form class="form-inline center">
                    ...
                    <select id="server" style="width: 120px">
                        <option value="" channel="<?php echo isset($max_channel) ?  $max_channel : '';?>"
                                cps="<?php echo isset($max_cps)? $max_cps : ''; ?>"><?php __('All') ?></option>
                        <?php foreach ($limit_servers as $limit_server): ?>
                            <option channel="<?php echo isset($limit_server[0]['max_channel']) ? $limit_server[0]['max_channel']: ''; ?>"
                                    cps="<?php echo isset($limit_server[0]['max_cps']) ? $limit_server[0]['max_cps'] : ''; ?>"
                    ...
                    <select id="duration" class="interval_all" style="width: 120px">
                        <?php foreach ($date_intervals as $key => $date_interval): ?>
                            <option value="<?php echo $key; ?>" <?php if($key == 1) echo 'selected="selected"';?> ><?php echo $date_interval; ?></option>
                        <?php endforeach; ?>
                    </select>
...
<script type="text/javascript">
    ...
    $(function () {
        $.post('<?php echo $this->webroot; ?>homes/getServerLimit',{}, function (response) {
            var _response = $.parseJSON(response);

            $("#max_channel").html(_response.max_channel);
            $("#max_cps").html(_response.max_cps);
        });
    });
...
//    window.setInterval('get_daily();', 1000 * 60 );
    window.setInterval('get_daily();', 1000 * 60 * 60 );
    /* end daily */
...
<script>
    /*//ajax_text1*/
    function ajax_text1(selectedValue) {
        ...
        $.getJSON(
            ...
            function (data) {
                asr_value.html((data['asr'] * 100).toFixed(2) + '% ('+data['non_zero_calls']+' calls)');
    ...
    function getDailyData() {
        ...
        margin.html("<img src='<?php echo $this->webroot?>images/check_waiting.gif' />");
        margin_pre.html("<img src='<?php echo $this->webroot?>images/check_waiting.gif' />");
        call.html("<img src='<?php echo $this->webroot?>images/check_waiting.gif' />");

        $.getJSON(
            "<?php echo $this->webroot ?>homes/get_admin_dashboard/1/2",
            function (data) {
                call_mins.html(data['call_mins']);
                margin.html(data['margin']);
                margin_pre.html(data['margin_pre']);
                call.html(data['calls']);
            }
        );
    }
    ...
    $(function () {
        ...
        setInterval(getDailyData, time_interval);
