...
<!--[if !IE]><!--><html class="animations fluid top-full menuh-top"><!-- <![endif]-->
    <head>
        <title><?php __('Reset Password :: Class4') ?></title>
    ...
    <body class="document-body login">
                ...
                <div class="wrapper" style="max-width:600px;margin-top:40px;">
                    ...
                    <div class="widget widget-heading-simple widget-body-gray">
                        ...
                        <div class="widget-body">
                            ...
                            <!-- Form -->
                            <form id="myform" method="post" action="<?php echo $this->webroot ?>homes/check_and_reset_password/<?php echo $url_code ?>">
                                <input type="hidden" name="lang" value="eng">
                                <label><b style="font-size: 16px;"><?php __('You may reset your password now.'); ?></b></label>
                                <label for="password"><?php __('New Password'); ?><span id="s_msg" style="color: Red; display: none; font-weight: bold; float: right;"><?php __('Password length is less than 6'); ?></span></label>
                                <input id="password" type="password" name="password" style="max-width:100%;" class="input-block-level validate[required,minSize[6]]" placeholder="<?php __('Password length must be greater than 6'); ?>" required/>
                                
                                <label for="repassword"><?php __('Confirm Password'); ?><span id="r_msg" style="color: Red; display: none; font-weight: bold; float: right;"><?php __('The two passwords do not match'); ?></span></label>
                                <input id="repassword" type="password" name="repassword" style="max-width:100%;" class="input-block-level validate[required,equals[password]]" placeholder="<?php __('Password must be consistent'); ?>" required/>
        ...
        <a class="btn btn-icon btn-inverse glyphicons circle_arrow_left" href="<?php echo $this->webroot?>homes/login"><i></i> <?php __('Back Login')?></a>
                                    ...
                                    <div class="span4">
                                        <button class="btn btn-block btn-inverse" type="submit"><?php __('Reset Password') ?></button>
                                    </div>
                                </div>
                            </form>
                            <!-- // Form END -->
