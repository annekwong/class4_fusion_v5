...
<head>
    ...
    <!-- Multiselect Plugin -->
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/forms/multiselect/css/multi-select.css"
          rel="stylesheet"/>
    ...
    <!--[if IE]><!-->
    <script src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/other/excanvas/excanvas.js"></script>
    <!--<![endif]-->
    <!--[if lt IE 8]>
    <script src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/other/json2.js"></script><![endif]-->

    <!-- Bootstrap Extended -->
    <link href="<?php echo $this->webroot; ?>common/bootstrap/extend/jasny-fileupload/css/fileupload.css"
          rel="stylesheet">
    <link
        href="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-wysihtml5/css/bootstrap-wysihtml5-0.0.2.css"
        rel="stylesheet">
    <link href="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-select/bootstrap-select.css"
          rel="stylesheet"/>
    <link
        href="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-toggle-buttons/static/stylesheets/bootstrap-toggle-buttons.css"
        rel="stylesheet"/>

    <!-- DateTimePicker Plugin -->
    <link
        href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/forms/bootstrap-datetimepicker/css/datetimepicker.css"
        rel="stylesheet"/>

    <!-- JQueryUI -->
    <link
        href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/system/jquery-ui/css/smoothness/jquery-ui-1.9.2.custom.min.css"
        rel="stylesheet"/>

    <!-- Multiselect Plugin -->
    <script
        src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/forms/multiselect/js/jquery.multi-select.js"></script>

    <!-- MiniColors ColorPicker Plugin -->
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/color/jquery-miniColors/jquery.miniColors.css"
          rel="stylesheet"/>
    ...
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/notifications/Gritter/css/jquery.gritter.css"
          rel="stylesheet"/>
    ...
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/other/google-code-prettify/prettify.css"
          rel="stylesheet"/>
    ...
    <!--[if gt IE 8]><!-->
    <link media="screen"
          href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/other/pageguide/css/pageguide.css"
          rel="stylesheet"/><!--<![endif]-->

    <!-- Bootstrap Image Gallery -->
    <link
        href="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-image-gallery/css/bootstrap-image-gallery.min.css"
        rel="stylesheet"/>

    <!-- Main Theme Stylesheet :: CSS -->
    <link href="<?php echo $this->webroot; ?>common/theme/css/style-default-menus-dark.css?1374506511" rel="stylesheet"
          type="text/css"/>

    <!-- Footable -->
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/FooTable/css/footable-0.1.css"
          rel="stylesheet"/>
    ...
    <link href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/media/css/DT_bootstrap.css"
          rel="stylesheet"/>
    <link
        href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/extras/TableTools/media/css/TableTools.css"
        rel="stylesheet"/>
    <link
        href="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/extras/ColVis/media/css/ColVis.css"
        rel="stylesheet"/>
    <script
        src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/media/js/jquery.dataTables.min.js"></script>
    <script
        src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/extras/TableTools/media/js/TableTools.min.js"></script>
    <script
        src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/extras/ColVis/media/js/ColVis.min.js"></script>
    <script
        src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/tables/DataTables/media/js/DT_bootstrap.js"></script>
    <!--  fakeLoader -->
...
<div class="container-fluid menu-hidden sidebar-hidden-phone fluid menu-left">
    <?php
    $web_url = $this->params['controller'] . '/' . $this->params['action'];
    ?>
    <!-- Content -->
    <div id="content" style="overflow: visible;">
        ...
        <?php if (!isset($noMenu)) : ?>
            ...
            <div class="navbar main" style="border: 0px;height: 44px;">
                ...
                <!-- Not Blank page -->
                <ul class="topnav pull-left hidden-phone"
                    style="background-color: white;height: 44px;width: 114px;padding: 0px;">
                    <a href='<?php echo $this->webroot . "homes/dashboard" ?>'>
                        <?php
                        ...
                        ?>
                        <img src="<?php echo $logo ?>" style="height: 44px;width: 114px;" alt=""/>
                    </a>
                </ul>
                <!-- Full Top Style -->
                ...
                <?php echo $this->element("project_menu/partition_menu_agent") ?>
                ...
                <?php if ($session->read('sst_user_id')): ?>
                    ...
                    <ul class="topnav pull-right hidden-phone" style="background-color: #393939;">
                        ...
                        <?php //echo $this->webroot ?><!--import_export_log/import" class="glyphicons upload single-icon"><i></i><span class="badge fix badge-primary">-->
                        <?php //echo count($appImportExportLog->display_upload_tip()); ?><!--</span></a></li>-->
                        <!--                                        --><?php //endif;?>
                        <!-- // Themer END -->
                        ...
                        <li class="account dropdown dd-1">
                            <a data-toggle="dropdown" href="<?php echo $this->webroot ?>homes/logout"
                               class="glyphicons logout lock"><span
                                    class="hidden-tablet hidden-phone hidden-desktop-1"><?php echo $session->read('sst_user_name') ?></span><i></i></a>
                            <ul class="dropdown-menu pull-right">
                                <?php if (PRI && $session->read('login_type') == 1) : ?>
                                    <li><a href="#themer" data-toggle="collapse" class="glyphicons eyedropper">Change
                                            Theme<i></i></a></li>
                                <?php endif; ?>
                                <li><a href="#myModal_changePassword" data-toggle="modal"
                                       class="glyphicons cogwheel"><?php __('Change Password'); ?><i></i></a></li>
                                <?php if ($session->read('get_support_enabled')): ?>
<!--                                    <li><a href="#myModal_support" data-toggle="modal"-->
<!--                                           class="glyphicons envelope">--><?php //__('Get Support'); ?><!--<i></i></a></li>-->
                                <?php endif; ?>
                                <?php if (!empty($_SESSION["version_info"]) && $session->read('login_type') == 1): ?>
                                    <li><a href="#myModal_about" data-toggle="modal"
                                           class="glyphicons circle_info"><?php __('About'); ?><i></i></a></li>
                                <?php endif; ?>
                                <?php if (!empty(Configure::read('help_link')) && $web_url != 'homes/dashboard'): ?>
<!--                                    <li><a href="--><?//= Configure::read('help_link') ?><!--" target="_blank"-->
<!--                                           class="glyphicons heart_empty">--><?php //__('Help'); ?><!--<i></i></a></li>-->
                                <?php elseif ($web_url == 'homes/dashboard'): ?>
<!--                                    <li>-->
<!--                                        <a href="--><?php //echo 'http://doc.denovolab.com:8090/display/CLASv5d2/Dashboard'; ?><!--"-->
<!--                                           target="_blank" class="glyphicons heart_empty">--><?php //__('Help'); ?>
<!--                                            <i></i></a></li>-->
                                <?php endif; ?>
                                <?php if ($session->read('login_type') == 3): ?>
<!--                                    <li><a href="#myModal_accountSetting" data-toggle="modal"-->
<!--                                           class="glyphicons cogwheel">--><?php //__('Account Setting'); ?><!--<i></i></a></li>-->
                                <?php endif; ?>
                                <li>
                                <span>
                                    <a class="btn btn-default btn-mini pull-right" style="border-color: #ccc"
                                       href="<?php echo $this->webroot ?>homes/logout">Sign Out</a>
                                </span>
                                </li>
                            </ul>
                        </li>
                ...
                <?php endif; ?>
                <?php if ($session->read('login_type') == 2 && isset($_SESSION["sst_agent_info"]["Agent"]["agent_id"])): ?>
                    <div id="copy_refferal_link" class="text-primary">
                        <span
                            id="copy_link">signup/index/<?php echo base64_encode($_SESSION["sst_agent_info"]["Agent"]["agent_id"]); ?> </span>
                        <a href="javascript:void(0)" onclick="copyToClipboard('copy_link')" class="copy-text"
                           title="<?php echo __('Copy Referral Link', true) ?>">
        ...
        <!--                 // Top Menu Right END-->
        <?php if (!isset($noMenu) && $session->read('login_type') == 1): ?>
            <!--            <div class="navbar main" style="z-index:100;position: relative;top:0px;width: 200px;float: right;background: rgba(0, 0, 0, 0) none repeat scroll 0 0;border: 0px;height: 38px">-->
            <!--                <ul class="topnav pull-right hidden-phone" style="background: rgba(0, 0, 0, 0) none repeat scroll 0 0">-->
            <!--                    <li style="border: 0px;height: 38px;line-height: 38px;"><a style="border: 0px;height: 38px;line-height: 38px;" href="--><?php //echo $this->webroot ?><!--import_export_log/import" class="glyphicons upload single-icon a_tip"><i></i><span class="badge fix badge-primary" style="border: 0px">--><?php //echo count($appImportExportLog->display_upload_tip()); ?><!--</span></a></li>-->
            <!--                    <li style="border: 0px;height: 38px;line-height: 38px;"><a style="border: 0px;height: 38px;line-height: 38px;" href="--><?php //echo $this->webroot ?><!--homes/alert" class="glyphicons alarm single-icon a_tip"><i></i><span class="badge fix badge-primary" style="border: 0px" id="alert_tip">--><?php //echo $appImportExportLog->diplay_alert_tip(); ?><!--</span></a></li>-->
            <!--                    <li style="border: 0px;height: 38px;line-height: 38px;"><a style="border: 0px;height: 38px;line-height: 38px;" href="#themer" data-toggle="collapse" class="glyphicons eyedropper single-icon a_tip"><i></i></a></li>-->
            <!--                </ul>-->
            <!--            </div>-->
        <?php endif; ?>
        ...
        <!-- Top navbar END -->
        <?php if (!isset($noMenu)) : ?>
            <div class="uptime" style="padding: 0 16px;top: 0px;height: 38px;line-height: 38px;margin: 0px;"
                 mb:format="%m/%d/%Y %H:%M:%S %z" mb:tz="<?php echo $_SESSION['sys_timezone']; ?>"
                 mb:stamp="<?php echo time(); ?>" id="topmenu-time">
                <?php
            ...
            <div class="widget-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input class="input in-text validate[required]" name="support_subject" id="support_subject"
                                   type="text">
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php echo __('content') ?> </td>
                        <td><textarea class="input in-textarea validate[required] support_content" style="width: 100%;"
                                      name="support_content" id="support_content"></textarea></td>
                    </tr>
                </table>
            </div>
            <div class="modal-footer">
                <input type="button" id="support_submit" class="btn btn-primary" value="<?php __('Submit'); ?>">
                <a href="javascript:void(0)" id="support_close" data-dismiss="modal"
                   class="btn btn-default"><?php __('Close'); ?></a>
            </div>
    ...
    <form action="" id="change_password_form" method="post">
        <div id="myModal_changePassword" class="modal hide">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" id="change_password_close" data-dismiss="modal"
                   class="btn btn-default"><?php __('Close'); ?></a>
            </div>
    ...
    <?php if ($session->read('login_type') == 3): ?>
        <form action="" id="change_account_setting" method="post">
            <div id="myModal_accountSetting" class="modal hide" data>
                <div class="modal-header">
                    <button data-dismiss="modal" class="close" type="button">&times;</button>
                    <h3><?php __('Change Account Setting'); ?></h3>
                </div>
                <div class="separator"></div>
                <div class="widget-body">
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-primary submit" value="<?php __('Submit'); ?>">
                    <a href="javascript:void(0)" id="change_account_close" data-dismiss="modal"
                       class="btn btn-default"><?php __('Close'); ?></a>
                </div>
    ...
    <div id="myModal_about" class="modal hide">
        ...
        <table class="footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary">
            ...
            <?php foreach ($_SESSION["version_info"] as $data_item): ?>
            <tr>
                <td><?php echo $data_item["VersionInfo"]["program_name"]; ?> </td>
                <td><?php echo $data_item["VersionInfo"]["major_ver"]; ?> </td>
                <td><?php echo $data_item["VersionInfo"]["build_date"]; ?> </td>
                <td><?php echo $data_item["VersionInfo"]["start_time"]; ?> </td>
                <?php endforeach; ?>
...
<script type="text/javascript">
    ...
    $("#myModal_accountSetting").on('shown', function () {
        var modal = $(this);
        modal.find('.widget-body').load("<?php echo $this->webroot; ?>homes/ajax_account_setting");
    });

    $("#change_account_setting .submit").click(function () {
        var validate_flg = $("#change_account_setting").validationEngine('validate');
        if (!validate_flg) {
            return false;
        }
        $.ajax({
            'url': '<?php echo $this->webroot ?>clients/ajax_change_account_setting',
            'type': 'POST',
            'dataType': 'json',
            'data': $("#change_account_setting").serialize(),
...
<div id="footer" class="hidden-print">
    ...
    <!--Version-->
    <div class="pr_version">
        <span>Release: <?php echo isset($_SESSION['current_version']) ? $_SESSION['current_version'] . ' | ' : ''; ?>
            <?php
            $currentVersion = array_filter($_SESSION["version_info"], function ($item) {
                return ($item["VersionInfo"]['program_name'] == 'dnl_softswitch');
            });
            $currentVersion = array_values($currentVersion)[0];

            ?>
        <?php echo isset($currentVersion["VersionInfo"]) ? $currentVersion["VersionInfo"]["build_date"] : '' ?></span>
    </div>
    <!--  End Version Line -->
...
<!-- Themer -->
<div id="themer" class="collapse" style="z-index:10000;">
    <div class="wrapper">
        <span class="close2" id="close_themer">&times; <?php __('close') ?></span>
        <h4><?php __('Themer') ?> <span><?php __('color options') ?></span></h4>
        <ul>
            <li><?php __('Theme') ?>: <select id="themer-theme" class="pull-right"></select>
                <div class="clearfix"></div>
            </li>
            <li><?php __('Primary Color') ?>: <input type="text" data-type="minicolors" data-default="#ffffff"
                                                     data-slider="hue" data-textfield="false" data-position="left"
                                                     id="themer-primary-cp"/>
                <div class="clearfix"></div>
            </li>
            <!--            <li>-->
            <!--                <span class="link" id="themer-custom-reset">-->
            <?php //__('reset theme') ?><!--</span>-->
            <!--                <span class="pull-right"><label>-->
            <?php //__('advanced') ?><!-- <input type="checkbox" value="1" id="themer-advanced-toggle" /></label></span>-->
            <!--            </li>-->
        </ul>
        <div>
            <hr class="separator"/>
            <button class="btn btn-inverse btn-small pull-right btn-icon glyphicons ok" id="themer_save">
                <i></i><?php __('Save') ?></button>
            <div class="clearfix"></div>
        </div>
    </div>
...
<div id="modal-gallery" class="modal modal-gallery hide fade hidden-print" tabindex="-1">
    ...
    <div class="modal-footer">
        ...
        <a class="btn btn-success modal-play modal-slideshow" data-slideshow="5000"><i
                class="icon-play icon-white"></i> <?php __('Slideshow') ?></a>
...
<!-- JQueryUI -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/system/jquery-ui/js/jquery-ui-1.9.2.custom.min.js"></script>

<!-- JQueryUI Touch Punch -->
<!-- small hack that enables the use of touch events on sites using the jQuery UI user interface library -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/system/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
...
<script
    src="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-toggle-buttons/static/js/jquery.toggle.buttons.js"></script>
...
<script
    src="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-wysihtml5/js/wysihtml5-0.3.0_rc2.min.js"></script>
<script
    src="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-wysihtml5/js/bootstrap-wysihtml5-0.0.2.js"></script>
...
<!-- Gritter Notifications Plugin -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/notifications/Gritter/js/jquery.gritter.min.js"></script>
...
<!-- MiniColors Plugin -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/color/jquery-miniColors/jquery.miniColors.js"></script>

<!-- DateTimePicker Plugin -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/forms/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
...
<!-- Select2 Plugin -->
<!--<script src="-->
<?php //echo $this->webroot; ?><!--common/theme/scripts/plugins/forms/select2/select2.js"></script>-->
...
<!-- Bootstrap Image Gallery -->
<script
    src="<?php echo $this->webroot; ?>common/theme/scripts/plugins/gallery/load-image/js/load-image.min.js"></script>
<script
    src="<?php echo $this->webroot; ?>common/bootstrap/extend/bootstrap-image-gallery/js/bootstrap-image-gallery.min.js"
...
<script type="text/javascript">
    ...
    function copyToClipboard(elementId) {
        ...
        aux.setAttribute("value", '<?php echo $appCommon->getUrl(); ?>' + document.getElementById(elementId).innerHTML);
        ...
        jGrowl_to_notyfy('Copied', {theme: 'jmsg-success'});
    }
    $(function () {
...
<script>
    function initPortValidation(port_limit = 65536) {

        $("input[name*='port']").on('keyup copy', function (e) {
            if ($(this).val() && $(this).val() > port_limit) {
                let value = port_limit;
                $(this).val(value);
                jGrowl_to_notyfy('<?php echo __('Port cannot be higher than 65536!', true);?>', {theme: 'jmsg-error'});
            }
        })

    }

    document.addEventListener("updatePortValidation", function (e) {
        initPortValidation();
    });
    ...
    $(function () {
        ...
        if ($('.dynamicTable:visible').find('thead').length > 0) {
            $('.dynamicTable:visible').each(function () {
                ...
                $(this).find('thead tr th').each(function (key, item) {
                    if ($(item).hasClass('columnHidden')) {
                        hiddenIndexes.push(key);
                    }
                })

                console.log('Hide indexes', hiddenIndexes);
...
//此时自动有overflow-x 需要另外的方式
            ...
            $('#show_hide_columns').live('click', function () {
                ...
                $('.ColVis_collection>button').attr({
                    'style': 'width: 182px; margin-left: 0px;',
            ...
            $(window).unload(function () {
                ...
                if (Object.keys(select_columns).length === 0) {
...
//此时自动有overflow-x 需要另外的方式
    ...
    $(document).ready(function () {
        $('.pagination #first_page, .pagination #prev_page').on('click', function (e) {
            if ($('.pagination li:eq(2)').hasClass('active')) {
                e.preventDefault();
                jGrowl_to_notyfy('<?php echo __('This is the first page.', true);?>', {theme: 'jmsg-error'});
            }
        })
        $('.pagination li:last').prev().on('click', function (e) {
            if ($(this).closest('li').prev().hasClass('active')) {
                e.preventDefault();
                jGrowl_to_notyfy('<?php echo __('This is the last page.', true);?>', {theme: 'jmsg-error'});
            }
        })
        $('.pagination li:last').on('click', function (e) {
            if ($(this).closest('li').prev().prev().hasClass('active')) {
                e.preventDefault();
                jGrowl_to_notyfy('<?php echo __('This is the last page.', true);?>', {theme: 'jmsg-error'});
            }
        })
        setTimeout(function () {
            $('.ColVis_collection > button').on('click', function () {
                var index = $('.ColVis_collection > button').index();
                var url = '<?php echo $this->params['controller'] . '_' . $this->params['action'] ?>';
                var select_columns = $.cookie('select_columns');
                var is_show_all = $('#show_hide_columns').attr('value');
                var show_columns_arr = {};
                var show_columns_arr_index = {};
                $(".dynamicTable:visible").floatThead('reflow');
                $('.ColVis_collection>button').each(function (i, item) {
                    if ($(item).find(':checkbox').is(':checked'))
                        show_columns_arr[i] = 1;
                    else
                        show_columns_arr[i] = 0;
                });
                show_columns_arr_index[index] = show_columns_arr;
                select_columns = select_columns ? JSON.parse(select_columns) : {};
                select_columns[url] = show_columns_arr_index;
                $.cookie('select_columns', JSON.stringify(select_columns), {path: "/"});
            });
        }, 1000);
    });
        ...
        $('#query-start_date-wDt').change(function () {
            {
                ...
                if (select < limit) {
                    ...
                    if (switch_select_code)
                        switch_select_code.prop('disabled', true).css({
                            'cursor': 'not-allowed',
                    ...
                    if (switch_select_code)
                        switch_select_code.prop('disabled', false).css({
                            'cursor': 'pointer',
        ...
        $('#query-start_date-wDt').change(function () {
            {
                ...
                if (select < limit_hourly) {
                    ...
                    switch_select_time_hourly.prop('disabled', true).css({
                        'cursor': 'not-allowed',
                        'background-color': '#ccc'
                    })
                } else {
                    switch_select_time_hourly.prop('disabled', false).css({
                        'cursor': 'pointer',
                        'background-color': '#fff'
                    })
                }
                ...
                if (select < limit_daily) {
                    ...
                    switch_select_time_daily.prop('disabled', true).css({
                        'cursor': 'not-allowed',
                        'background-color': '#ccc'
                    })
                } else {
                    switch_select_time_daily.prop('disabled', false).css({
                        'cursor': 'pointer',
                        'background-color': '#fff'
                    })
                }
