...
<script type="text/javascript">
	 ...
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>disconnectreports_db/flash_setting.xml?f=cdr_count&report_type=<?echo  $report_type ?>"));
...
<script type="text/javascript">
	 var so = new SWFObject("<?php echo $this->webroot?>amstock/amstock.swf", "amstock", "100%", "450", "8", "#FFFFFF");
	 so.addVariable("path", "<?php	echo $this->webroot?>amstock/");
	 so.addVariable("settings_file", encodeURIComponent("<?php echo $this->webroot?>disconnectreports_db/flash_setting.xml?f=cdr_count_percentage&report_type=<?echo  $report_type ?>"));
