<fieldset class="query-box" style=" clear:both;overflow:hidden;margin-top:10px;margin-left: 15px">
    ...
    <div style="margin:0px auto; text-align:center;">
        <form action="<?php echo $this->webroot ?>homes/show_charts" method="get">

            <div style="text-align: left">
                <span style="display:inline-block;width: 140px"><?php __('Statistical Information')?>:</span>
            ...
            <div style="text-align: left">
                <span style="display:inline-block;width: 140px"><?php __('Group Time')?>:</span>
                <select name="group_time" style="width: 133px">
            ...
            <div  style="text-align: left">
                <span style="display:inline-block;width: 140px"><?php __('Country')?>:</span>
...
<script>
    $(function(){
        ...
        var v3 = '<?php echo isset($_POST['type']) ? $_POST['type'] : '0'?>';
        type.find('option[value="'+v3+'"]').prop('selected',true);

        var group_time = $('select[name="group_time"]');
        var v4 = '<?php echo isset($_POST['group_time']) ? $_POST['group_time'] : '1'?>';
        group_time.find('option[value="'+v4+'"]').prop('selected',true);
