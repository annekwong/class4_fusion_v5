...
<td><input type="text" id="query-code_term"			
				 value="" name="query[code_term]"
				class="input width220"/>
  <!--
  <a href="#" onclick="ss_code_term(undefined, _ss_ids_code_term)"><img width="9" height="9"
