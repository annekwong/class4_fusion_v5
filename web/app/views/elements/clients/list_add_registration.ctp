...
<div class="innerLR">
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-body">
            ...
            <?php echo $form->create('Client', array('action' => 'add', 'url' => '/clients/add_registration', 'id' => 'ClientForm')); ?>
            <?php
            if (!empty($post[0][0]['id']))
            {
                echo "<input type=\"hidden\" name=\"order_user_id\" value=\"{$post[0][0]['id']}\" />";
            }
            ?>
            <input type='hidden' name='registration_id' value='<?php echo $registration_id?>' />
            <input type='hidden' name='registration_url' value='<?php echo $registration_url?>' />
...
<!--                        <col width="40%"/>
                            ...
                            <div class="widget-body">
                                <table class="form footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary default footable-loaded">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $form->input('company', array('maxlength' => 256, 'label' => false, 'div' => false, 'class' => 'input in-text in-input validate[maxSize[200],custom[onlyLetterNumberLineSpace]]', 'value' => $registration_info['company'])) ?>
                                        </td>
                                        <td class="align_right padding-r20"><?php echo __('address') ?> </td>
                                        <td>
                                            <?php echo $form->input('address', array('label' => false, 'div' => false, 'rows' => '5', 'maxlength' => '500', 'type' => 'textarea', 'class' => 'input in-text in-input', 'value' => $registration_info['address'])) ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align_right padding-r20"><?php echo __('Main e-mail', true); ?> </td>
                                        <td> <?php echo $form->input('email', array('label' => false, 'div' => false, 'maxLength' => '100', 'class' => 'validate[custom[email]]', 'value' => $registration_info['email'])) ?></td>
                                        <td class="align_right padding-r20"><?php echo __('NOC e-mail', true); ?> </td>

                                        <td> <?php echo $form->input('noc_email', array('label' => false, 'div' => false, 'maxLength' => '100', 'class' => 'validate[custom[email]]', 'value' => $registration_info['noc_email'])) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="align_right padding-r20"><?php echo __('Billing e-mail', true); ?> </td>
                                        <td> <?php echo $form->input('billing_email', array('label' => false, 'div' => false, 'maxLength' => '100', 'class' => 'validate[custom[email]]',  'value' => $registration_info['billing_email'])) ?></td>
                                        <td class="align_right padding-r20"><?php echo __('Rates e-mail', true); ?> </td>
                                        <td> <?php echo $form->input('rate_email', array('label' => false, 'div' => false, 'maxLength' => '100', 'class' => 'validate[custom[email]]' , 'value' => $registration_info['rate_email'])) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="align_right padding-r20"><?php echo __('Rate Delivery Email', true); ?> </td>
                                        <td> <?php echo $form->input('rate_delivery_email', array('label' => false, 'div' => false, 'maxLength' => '100', 'class' => 'validate[custom[email]]', 'value' => $registration_info['rate_delivery_email'])) ?></td>
                                        <td class="align_right padding-r20"><?php echo __('Tax ID', true); ?> </td>
                                        <td> <?php echo $form->input('tax_id', array('label' => false, 'div' => false, 'class' => 'validate[custom[onlyNumber]]', 'value' => $registration_info['tax_id']))  ?></td>
                                    </tr>
                                    <tr>
                                        <td class="align_right padding-r20"><?php echo __('Account Details', true); ?> </td>
                                        <td> <?php echo $form->input('details', array('label' => false, 'div' => false, 'rows' => '5', 'class' => 'input in-text in-input', 'value' => $registration_info['details'])) ?></td>
                                    </tr>
                        ...
                        <div class="widget" data-toggle="collapse-widget" data-collapse-closed="true">
                            ...
                            <div class="widget-body">
                                <table class="white-background form footable table table-striped  tableTools table-bordered  table-white table-primary default footable-loaded">
                                    <thead></thead>
                                    ...
                                    <tr class="tr-green tr-hidden daily_alert_on">
                                        <td></td>
                                        <td>
                                            <span>Recipient:</span>
                                            <?php
                                    ...
                                    <tr>
                                        <td class="align_right padding-r20">
                                            <?php
                                            echo $form->input('is_auto_summary', array('class' => 'toggle-next in-decimal input in-checkbox', 'label' => false, 'div' => false, 'type' => 'checkbox'));
                                            ?>
                                        </td>
                                        <td  style="text-align: left;">
                                            <?php __('Enable Daily Usage Summary') ?>
                                        </td>
                                    <tr class="tr-green tr-hidden">
                                        <td></td>
                                        <td>
                                    ...
                                    <tr class="tr-green tr-hidden">
                                        <td></td>
                                        <td class="low_balance_config_table">
                                            ...
                                            <br />
                                            <?php echo __('notifyclientbalance')?>:
                                            <?php echo $form->input('notify_client_balance',array('class'=>'in-decimal input in-text','label'=>false,'div'=>false, 'style'=>'width:150px;',
                                            'value'=>'',
                                            'type'=>'text'))?>
                                            <?php echo $form->input('notify_client_balance_type',array('options'=>array(0=>'Actual Balance', 1 => 'Percentage'),'label'=>false, 'style'=>'width:100px;' ,'div'=>false,'type'=>'select','class'=>'input in-text in-select'));?>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="widget" data-toggle="collapse-widget" data-collapse-closed="true">
                            <div class="widget-head"><h4 class="heading">
                                    <?php echo $form->checkbox('is_panelaccess',array('checked' => 'checked')); ?>
                            ...
                            <div class="widget-body">
                                ...
                                <table class="form footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary default footable-loaded">
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $form->input('login', array('maxlength' => 256, 'label' => false, 'div' => false, 'class' => 'validate[required]', 'value' => $registration_info['login'])) ?>
                                        </td>
                                        <td class="align_right padding-r20"><?php echo __('New Password', true) ?> </td>
                                        <td> <?php echo $form->input('password', array('label' => false, 'div' => false, 'type' => 'password', 'maxLength' => '64' , 'value' => $registration_info['password'])); ?></td>
                                    </tr>
                                    <tr>
...
<script>
    $(function () {
        ...
        let login = '<?php echo isset($registration_info["login"]) ? $registration_info["login"] : ""; ?>';
        let password = '<?php echo isset($registration_info["password"]) ? $registration_info["password"] : ""; ?>';
        if(login){
            jQuery('#ClientLogin').val(login)
        }
        if(password){
