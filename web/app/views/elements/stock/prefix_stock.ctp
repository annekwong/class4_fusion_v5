...
<div id="stock">
    ...
    <div id="control">
        <select>
            ...
            <option value="prefix_stats_call"><?php __('Calls')?></option>
            <option value="prefix_stats_cps"><?php __('CPS')?></option>
            <option value="prefix_stats_acd"><?php __('ACD')?></option>
            <option value="prefix_stats_pdd"><?php __('PDD')?></option>
            <option value="prefix_stats_asr"><?php __('ABR')?></option>
        </select>
    </div>
</div>
