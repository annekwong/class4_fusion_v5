...
<tr class="period-block">
    <td colspan="8" style="width:auto;"><table class="in-date" <?php if(!isset($report_name)): ?>style="width: 98%" <?php endif; ?>>
            <tbody>
                <tr>
                    <td class="align_left padding-r10"><?php __('time') ?> </td>
                    ...
                    <td style="width:200px"><input type="text" id="query-start_date-wDt"
                                                   ...
                                                   name="start_time" class="input in-text"></td>
                    ...
                    <td class="align_left padding-r10"><?php __('Ingress Trunk')?></td>
                    <td class="value">
                        <select class="trunk_options_ingress" id="ingress_id" name="ingress_id" <!--onchange="getTechPrefix(this);"-->>
                            <?php
