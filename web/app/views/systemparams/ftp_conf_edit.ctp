<style>
    .table-condensed tr td table td{border-top: 0}
    table input,select{margin:5px 0;width: 220px;}
</style>
<ul class="breadcrumb">
...
<!--        <div class="widget-head">
            ...
            <ul class="tabs">
                <li class="active">
                    <a class="glyphicons cogwheel"  href="<?php echo $this->webroot ?>systemparams/ftp_conf">
                        <i></i>
                        <?php __('FTP Config') ?>
                    </a>
                </li>
                <li>
                    <a class="glyphicons fire"  href="<?php echo $this->webroot ?>systemparams/ftp_trigger">
                        <i></i>
                        <?php __('Trigger') ?>
                    </a>
                </li>
