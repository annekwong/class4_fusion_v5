        ...
        <div class="widget widget-tabs widget-body-white">
            ...
            <div class="widget-head">
                <ul class="tabs">
                    ...
                    <li class='active'><a href="<?php echo $this->webroot ?>usagedetails/term_summary_reports"  class="glyphicons right_arrow"><i></i><?php __('Termination')?></a>  </li>
            ...
            <div class="widget-body">
                ...
                <?php if (empty($data)): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="rows" style="overflow-x:scroll;">
                            <?php
                            $days = array();
...
<!--                                    <td>Rate Type</td>
                                    <td>
                                        <select name="orig_rate_type">
                                            ...
                                            <option value="1" <?php echo $common->set_get_select('orig_rate_type', 1); ?>>INTER</option>
                                            <option value="2" <?php echo $common->set_get_select('orig_rate_type', 2); ?>>INTRA</option>
                                            <option value="3" <?php echo $common->set_get_select('orig_rate_type', 3); ?>>OTHER</option>
                                            <option value="4" <?php echo $common->set_get_select('orig_rate_type', 4); ?>>ERROR</option>
                                            <option value="5" <?php echo $common->set_get_select('orig_rate_type', 5); ?>>LOCAL</option>
                                        </select>
<?php echo $this->element('search_report/ss_clear_input_select'); ?>
                                    </td>
                                    <td>&nbsp;</td>-->
                                    ...
                                    <td>
                                        <select name="term_rate_type">
                                            ...
                                            <option value="1" <?php echo $common->set_get_select('term_rate_type', 1); ?>><?php __('INTER')?></option>
                                            <option value="2" <?php echo $common->set_get_select('term_rate_type', 2); ?>><?php __('INTRA')?></option>
                                            <option value="3" <?php echo $common->set_get_select('term_rate_type', 3); ?>><?php __('OTHER')?></option>
                                            <option value="4" <?php echo $common->set_get_select('term_rate_type', 4); ?>><?php __('ERROR')?></option>
                                            <option value="5" <?php echo $common->set_get_select('term_rate_type', 5); ?>><?php __('LOCAL')?></option>
                                        </select>
<?php echo $this->element('search_report/ss_clear_input_select'); ?>
                                    </td>
                                    <td>&nbsp;</td>
...
<!--                                    <td>Jurisdiction Type</td>
                                    <td>
                                        <select name="ingress_jur_type">
                                            <option value="" <?php echo $common->set_get_select('ingress_jur_type', ''); ?>>All</option>
                                            <option value="0" <?php echo $common->set_get_select('ingress_jur_type', 0); ?>>A-Z</option>
                                            <option value="1" <?php echo $common->set_get_select('ingress_jur_type', 1); ?>>US NON-JD</option>
                                            <option value="2" <?php echo $common->set_get_select('ingress_jur_type', 2); ?>>US JD</option>
                                            <option value="3" <?php echo $common->set_get_select('ingress_jur_type', 3); ?>>OCN-LATA-JD</option>
                                            <option value="4" <?php echo $common->set_get_select('ingress_jur_type', 4); ?>>OCN-LATA-NON-JD</option>
                                        </select>
<?php echo $this->element('search_report/ss_clear_input_select'); ?>
                                    </td>
                                    <td>&nbsp;</td>-->
