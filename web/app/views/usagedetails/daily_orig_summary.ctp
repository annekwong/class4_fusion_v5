...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Detail Summary Report') ?></li>
</ul>
    ...
    <div class="widget widget-tabs widget-body-white">
        ...
        <div class="widget-head">
           <ul class="tabs">
            ...
            <li class='active'><a href="<?php echo $this->webroot?>usagedetails/daily_orig_summary"  class="glyphicons left_arrow"><i></i><?php __('Daily Origination')?></a></li>
