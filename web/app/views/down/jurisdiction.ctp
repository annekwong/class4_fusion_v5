...
<ul class="breadcrumb">
    ...
    <?php foreach ($header as $header_item): ?>
        ...
        <li><a href="<?php echo $this->webroot ?>down/jurisdiction"><?php __($header_item) ?></a></li>
    <?php endforeach; ?>
</ul>
...
<div class="innerLR">
    ...
    <div class="widget widget-tabs widget-body-white">
        <div class="widget-head">
            <ul class="tabs">
                <li ><a class="glyphicons list" href="<?php echo $this->webroot ?>jurisdictionprefixs/view"><i></i> <?php echo __('List', true); ?></a></li>
                <li><a class="glyphicons upload" href="<?php echo $this->webroot ?>uploads/jur_country"><i></i>  <?php echo __('Import', true); ?></a></li> 
                <li  class="active"><a class="glyphicons download" href="<?php echo $this->webroot ?>down/jurisdiction"><i></i> <?php echo __('Export', true); ?></a></li>   
            </ul>
        </div>
