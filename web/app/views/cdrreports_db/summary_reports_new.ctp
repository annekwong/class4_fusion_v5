...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->webroot ?>cdrreports_db/summary_reports_new">
...
<script>
    ...
    var currentUrl = "<?php echo $this->webroot; ?>cdrreports_db/ajaxCdrRequest";
    var formObject = $("#report_form");
    var report = new Report(currentUrl, formObject);
    var Vue = new Vue({
        el: "#app",
        data: {
            fields : [],
