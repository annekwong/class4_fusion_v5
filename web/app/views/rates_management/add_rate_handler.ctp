...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Add Rate Handler', true); ?></li>
</ul>
            ...
            <form action="<?php echo $this->webroot; ?>rates_management/add_save_rate_handler_handle" method="post" >
                <table class="table table-condensed" >
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="rate_delivery_from" class="input-xlarge validate[custom[email]]" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php __('Rate Delivery To') ?></td>
                        <td>
                            <input type="text" name="rate_delivery_to" class="input-xlarge validate[custom[email]]" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"> <?php __('SMTP Host') ?></td>
                        <td>
                            <input type="text" name="smtp_host" class="validate[required]" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php __('SMTP Port') ?></td>
                        <td>
                            <input type="text" name="smtp_port" class="validate[required]" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php __('Imap Host') ?></td>
                        <td>
                            <input type="text" name="imap_host" class="validate[required]" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php __('Imap Port') ?></td>
                        <td>
                            <input type="text" name="imap_port" class="validate[required]" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="mail_ssl" class="input-xlarge" type="checkbox" name="mail_ssl" />
                        </td>
                    </tr>
                    <tr>
                        <td class="align_right"><?php __('TLS Auth') ?></td>
                        <td>
                            <input id="mail_tls" class="input-xlarge" type="checkbox" name="mail_tls">
                        </td>
                    </tr>
