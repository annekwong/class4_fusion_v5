<ul class="breadcrumb">
    ...
    <li><a href="<?= $this->webroot?>task_scheduler/scheduler_log">
        <?php __('Log') ?></a></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?= $this->webroot?>task_scheduler/scheduler_log">
        <?php echo __('Scheduler Log', true); ?></a></li>
</ul>
...
<div class="buttons pull-right newpadding">
        <a class="btn btn-primary btn-icon glyphicons roundabout" href="<?php echo $this->webroot; ?>task_scheduler/scheduler_log_by_name?<?php echo $$hel->getParams('getUrl') ?>"><i></i><?php __('Group By Name') ?></a>
</div>
<div class="clearfix"></div>
<div class="innerLR">
                    ...
                    <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $item)
                            {
                                ?>
                                <tr>
                                    <td><?php echo $item[0]['script_name']; ?></td>
