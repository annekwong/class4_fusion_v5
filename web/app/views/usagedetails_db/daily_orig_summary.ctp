...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?php echo $this->webroot ?>usagedetails_db/daily_orig_summary">
        <?php echo __('Detail Summary Report') ?></a></li>
</ul>

<div class="heading-buttons">
    <h4 class="heading"><?php echo __('Detail Summary Report') ?></h4>
        ...
        <div class="widget-head">
            <ul class="tabs">
               ...
               ?>
                ...
                ?>
                <li class='active'><a href="<?php echo $this->webroot ?>usagedetails_db/daily_orig_summary"  class="glyphicons left_arrow"><i></i>Daily Origination</a></li>
                <?php
                    if($res[0][0]['all_termination'] == 't'){
               ?>
    ...
    <?php echo round($total_item_total / 60, 2); ?>
                ...
                <fieldset class="query-box" style=" clear:both;overflow:hidden;margin-top:10px;">
                    <h4 class="heading glyphicons search"><i></i> <?php __('search') ?></h4>
                            <?php echo $this->element('search_report/search_js'); ?><?php echo $form->create('Cdr', array('type' => 'get', 'url' => '/usagedetails_db/daily_orig_summary/', 'onsubmit' => "if ($('#query-output').val() == 'web') loading();")); ?>  <?php echo $this->element('search_report/search_hide_input'); ?>
