...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->webroot ?>cdrapi/daily_usage">
            <?php __('Statistics') ?></a></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?php echo $this->webroot ?>cdrapi/daily_usage">
            <?php __('Daily Usage Report') ?></a></li>
</ul>
<div class="heading-buttons">
    <h4 class="heading">
        <?php __('Daily Usage Report'); ?>
    </h4>
</div>
        ...
        <div class="widget-head">
            <ul>
                <li <?php if ($type == 1) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>cdrapi/daily_usage/1"class="glyphicons left_arrow">
                        <i></i>
                        <?php __('Origination')?>
                    </a>
                </li>
                <li <?php if ($type == 2) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>cdrapi/daily_usage/2"class="glyphicons right_arrow">
                        <i></i>
                        <?php __('Termination')?>
                    </a>
                </li>
        ...
        <div class="widget-body">
            ...
            <fieldset class="query-box" style=" clear:both;margin-top:10px;">
                ...
                <div id="advance_panel" class="widget widget-heading-simple widget-body-gray">
                    <table class="form" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td  valign="top" rowspan="9" colspan="2" style="padding-left: 10px;width:25%;">
                                ...
                                ?>
                                <button type="button" class="btn btn-primary" style="display:block; width: 100%;" onclick="saveFields('<?php echo $this->webroot; ?>', '<?php echo $type == 1 ? 'daily_usage' : 'daily_usage_term'; ?>')">Save fields as default</button>
                            </td>
                        </tr>
                    ...
                    <input type="hidden" name="group_by_date" value="1440">
...
<script>
    ...
    <?php if ($type == 1): ?>
    var fields = [
        "not_zero_calls", "total_duration", "not_zero_calls_6", "not_zero_calls_6_percent", "not_zero_calls_30",
        "not_zero_calls_30_percent", "total_billable_time", "asr", "acd", "npr_count", "npr"
    ];
    <?php else: ?>
    var fields = [
        "not_zero_calls", "total_duration_term", "not_zero_calls_6", "not_zero_calls_6_percent", "not_zero_calls_30",
        "not_zero_calls_30_percent", "total_billable_time_term", "asr_term", "acd_term", "npr_count", "npr_term"
    ];
    <?php endif;?>
