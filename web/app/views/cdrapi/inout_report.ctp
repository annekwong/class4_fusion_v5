...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->webroot ?>cdrapi/inout_report">
            <?php __('Statistics') ?></a></li>
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><a href="<?php echo $this->webroot ?>cdrapi/inout_report">
            <?php __('Inbound/Outbound Report') ?></a></li>
</ul>
<div class="heading-buttons">
    <h4 class="heading">
        <?php __('Inbound/Outbound Report'); ?>
    </h4>
</div>
                    ...
                    <table class="form" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td  valign="top" rowspan="9" colspan="2" style="padding-left: 10px;width:25%;">
                                ...
                                ?>
                                <button type="button" class="btn btn-primary" style="display:block; width: 100%;" onclick="saveFields('<?php echo $this->webroot; ?>', 'inout_report')">Save fields as default</button>
                            </td>
                        </tr>
...
<script>
    ...
    /**
     * Needs to add total duration and ACD
     * @type {string[]}
     */
    var fields = [
        "total_billable_time", "total_cost", "average_rate", "total_billable_time_term", "total_cost_term", "average_rate_term",
        "asr_global", "pdd", "npr_count", "npr_global", "calls", "not_zero_calls", "busy_calls"
    ];
