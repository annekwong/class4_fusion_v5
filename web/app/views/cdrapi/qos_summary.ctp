...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->webroot ?>cdrapi/qos_summary">
        ...
        <div class="widget-head">
            <ul>
                <li <?php if ($type == 1) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>cdrapi/qos_summary/1"class="glyphicons left_arrow">
                        <i></i>
                        <?php __('Origination')?>
                    </a>
                </li>
                <li <?php if ($type == 2) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>cdrapi/qos_summary/2"class="glyphicons right_arrow">
                        <i></i>
                        <?php __('Termination')?>
                    </a>
                </li>
                    ...
                    <table class="form" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td  valign="top" rowspan="9" colspan="2" style="padding-left: 10px;width:25%;">
                                ...
                                ?>
                                <button type="button" class="btn btn-primary" style="display:block; width: 100%;" onclick="saveFields('<?php echo $this->webroot; ?>', '<?php echo $type == 1 ? 'qos_summary' : 'qos_summary_term'; ?>')">Save fields as default</button>
                            </td>
                        </tr>
...
<script>
    ...
    <?php if ($type == 1): ?>
    var fields = [
        "asr", "acd", "pdd", "total_billable_time", "total_calls", "not_zero_calls", "busy_calls"
    ];
    <?php else: ?>
    var fields = [
        "asr_term", "acd_term", "pdd_term", "total_billable_time_term", "total_calls_term", "not_zero_calls", "busy_calls_term"
    ];
    <?php endif;?>
