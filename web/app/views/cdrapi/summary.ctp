...
<script>
    ...
    <?php if ($type == 1): ?>
    var fields = [
        "asr", "acd", "pdd", "npr_count", "npr", "sd_count", "sdp", "revenue", "profit", "nrf_count", "nrf", "limited",
        "margin", "pp_min", "pp_k_calls", "ppka", "total_duration", "total_billable_time", "total_cost", "inter_cost",
        "intra_cost", "local_cost", "ij_cost", "average_rate", "total_calls", "not_zero_calls", "success_calls", "busy_calls"
    ];
    <?php else: ?>
    var fields = [
        "asr_term", "acd_term", "pdd_term", "npr_count", "npr_term", "sd_count", "sdp", "revenue_term", "profit", "nrf_count", "nrf_term",
        "limited", "margin", "pp_min", "pp_k_calls", "ppka", "total_duration_term", "total_billable_time_term", "total_cost_term",
        "inter_cost_term", "intra_cost_term", "local_cost_term", "ij_cost_term", "average_rate_term", "total_calls_term",
        "not_zero_calls", "busy_calls_term"
    ];
    <?php endif;?>
