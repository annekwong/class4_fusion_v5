...
<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Finance Fee') ?></li>
</ul>


<div class="heading-buttons">
    <h4 class="heading"><?php __('Finance Fee') ?></h4>

</div>
<div class="separator bottom"></div>
<div class="buttons pull-right newpadding">
    <?php if ($_SESSION['role_menu']['Finance']['paymentterms:finance_fee']['model_w'])
    {
        ?>
...
<?php $w = $session->read('writable'); ?>
            ...
            <div id="container">
                ...
                {
                    ?>
                    <div class="msg center"  id="msg_div"><br/><h2><?php echo __('no_data_found') ?></h2></div>
                <?php
                }
                else
                {
                    ?>
                    <div class="msg center"  id="msg_div"  style="display: none;"><br/><h2><?php echo __('no_data_found') ?></h2></div>
                <?php } ?>
                <?php
                $d = $p->getDataArray();
                if (count($d) == 0)
