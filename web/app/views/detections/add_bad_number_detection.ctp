                        ...
                        <div id="tab1" class="tab-pane active">
                            <table class="table dynamicTable tableTools table-bordered  table-white table-primary">
                                <tr id="target_tr">
                                    ...
                                    <td>
                                        <select name="target">
                                            <option value="0"><?php __('ANI') ?></option>
                                            <option value="1"><?php __('DNIS') ?></option>
                                        </select>
                                    </td>
                                </tr>
                                <tr id="valid_attempts_tr">
                                    ...
                                    <td>
                                        <input value="74.117.36.136" type="text" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46' name="ip" id="ip" style="width: 100%" required>
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="valid_attempts_tr">
                                    ...
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="valid_attempts" id="valid_attempts" required>
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p200_tr">
                                    <td>
                                        <label><input type="checkbox" name="p200c" id="p200c">
                                        <?php __('Percentage of 200 OK'); ?></label>
                                    </td>
                                    <td>
                                        <= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p200" id="p200">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p404_tr">
                                    <td>
                                        <label><input type="checkbox" name="p404c" id="p404c">
                                        <?php __('Percentage of 404'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p404" id="p404">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p503_tr">
                                    <td>
                                        <label><input type="checkbox" name="p503c" id="p503c">
                                        <?php __('Percentage of 503'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p503" id="p503">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p480_tr">
                                    <td>
                                        <label><input type="checkbox" name="p480c" id="p480c">
                                        <?php __('Percentage of 480'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p480" id="p480">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p486_tr">
                                    <td>
                                        <label><input type="checkbox" name="p486c" id="p486c">
                                        <?php __('Percentage of 486'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p486" id="p486">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p487_tr">
                                    <td>
                                        <label><input type="checkbox" name="p487c" id="p487c">
                                        <?php __('Percentage of 487'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p487" id="p487">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="p45_tr">
                                    <td>
                                        <label><input type="checkbox" name="p45c" id="p45c">
                                        <?php __('Percentage of 4xx and 5xx'); ?></label>
                                    </td>
                                    <td>
                                        >= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="p45" id="p45">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="asr_tr">
                                    <td>
                                        <label><input type="checkbox" name="asrc" id="asrc">
                                        <?php __('ASR'); ?></label>
                                    </td>
                                    <td>
                                        <= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="asr" id="asr">%
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="acd_tr">
                                    <td>
                                        <label><input type="checkbox" name="acdc" id="acdc">
                                        <?php __('ACD'); ?></label>
                                    </td>
                                    <td>
                                        <= <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="acd" id="acd">s
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                            </table>
                                ...
                                <tr id="block_type_tr">
                                    ...
                                    <td>
                                        <select name="block_type" id="block_type">
                                            <option value="0"><?php __('Global Block') ?></option>
                                            <option value="1"><?php __('Block for Ingress') ?></option>
                                            <option value="2"><?php __('Block for Egress') ?></option>
                                        </select>
                                    </td>
                                </tr>
                                <tr id="trunk_list_tr">
                        ...
                        <div id="tab3" class="tab-pane">
                            <table class="table dynamicTable tableTools table-bordered  table-white table-primary">
                                ...
                                <tr id="exec_every_tr">
                                    ...
                                    <td>
                                        <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="exec_every" id="exec_every" required> Min
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr id="from_last_tr">
                                    ...
                                    <td>
                                        <input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="from_last" id="from_last" required> Min
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                            </table>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $.each(res, function (i, trunk) {
                            options += '<option value="' + trunk[0].resource_id + '">' + trunk[0].alias + '</option>';
//                            console.log(trunk);
                        });
                        $('#trunk_list').html('');
