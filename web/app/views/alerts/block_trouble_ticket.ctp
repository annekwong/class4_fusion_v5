<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Block Trouble Ticket', true); ?></li>
</ul>

<div class="heading-buttons">
    <h4 class="heading"><?php echo __('Block Trouble Ticket', true); ?></h4>
        ...
        <div class="widget-body">
            ...
            else
            {
                ...
                <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary">
                    <thead>
                        <tr>
                            <th><?php echo $appCommon->show_order('block_on', __('Sent On', true)) ?></th>
                            <th><?php echo $appCommon->show_order('block_by', __('Sent By', true)) ?></th>
