<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php __('Egress Mutual Balance') ?>[<?php echo $client_name ?>]</li>
</ul>


<div class="heading-buttons">
    <h4 class="heading"><?php __('Egress Mutual Balance') ?>[<?php echo $client_name ?>]</h4>
...
<div class="buttons pull-right newpadding">
        ...
        <?php endif; ?>
        <a href="<?php echo $this->webroot; ?>finances/get_mutual_egress_detail/<?php echo $this->params['pass'][0] ?>?export=1" title="Export" class="btn btn-primary btn-icon glyphicons file_export">
            <i></i> <?php __('Export'); ?>            
        </a>
