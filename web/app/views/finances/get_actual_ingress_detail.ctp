<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php __('Ingress Actual Balance') ?>[<?php echo $client_name ?>]</li>
</ul>
...
<div class="buttons pull-right newpadding">
        ...
        <a href="<?php echo $this->webroot; ?>finances/get_actual_ingress_detail/<?php echo $this->params['pass'][0] ?>?export=1" title="Export" class="btn btn-primary btn-icon glyphicons file_export">
            <i></i> <?php __('Export'); ?>            
        </a>
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-body">
            ...
            <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary">
                <thead>
                    <tr>
                        <th colspan="4"><?php __('Beginning Balance on')?> <?php echo $start_time; ?> 00:00:00 <?php __('is')?> <?php echo $begin_balance; ?></th>
