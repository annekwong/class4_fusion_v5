    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="value value2"><?php echo $form->input('module_name',
 		array('label'=>false ,'div'=>false,'type'=>'text','class'=>'input in-text validate[required,custom[onlyLetterSp]]','maxLength'=>'256'));?></td>
      </tr>
      <tr>
...
<script>
   $('#SysmoduleAddSysmoduleForm').find('input[type="reset"]').on('click', function(){
       $('#SysmoduleAddSysmoduleForm').validationEngine('hide');
   });
</script>
