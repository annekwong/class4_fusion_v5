<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('New Sell Order') ?></li>
</ul>
<div class="heading-buttons">
    <h4 class="heading"><?php echo __('New Sell Order') ?></h4>
</div>
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-body">
                ...
                if (count($data) == 0) {
                    ...
                    <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary" id="key_list" >
                        <thead>
                            ...
                            <tr>
                                <th><?php echo $appCommon->show_order('client_name', __('Client Name', true)) ?></th>
                                <th>Flag</th>
                                <th><?php echo $appCommon->show_order('total', __('Total', true)) ?></th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <script>
                ...
                $(function() {
                    //setPeriods("curDay");
                    $("#smartPeriod").attr('value', "<?php if (isset($_GET['query']['smartPeriod'])) {
                    echo $_GET['query']['smartPeriod'];
                } else {
                    echo 'custom';
                } ?>");
                    $("#tz").attr('value', "<?php if (isset($_GET['tz'])) {
                    echo $_GET['tz'];
                } else {
                    echo '+0000';
                } ?>");
                    $("#query-start_date-wDt1").attr('value', "<?php if (isset($_GET['start_date'])) {
                    echo $_GET['start_date'];
                } else {
                    echo date('Y-m-d 00:00:00');
                } ?>");
                    $("#query-stop_date-wDt1").attr('value', "<?php if (isset($_GET['stop_date'])) {
                    echo $_GET['stop_date'];
                } else {
