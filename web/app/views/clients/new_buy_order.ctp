<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('New Buy Order') ?></li>
</ul>
<div class="heading-buttons">
    <h4 class="heading"><?php __('New Buy Order') ?></h4>
</div>
    ...
    <div class="widget widget-heading-simple widget-body-white">
        <div class="widget-body">
            ...
            <div id="container">
                ...
                if (count($data) == 0) {
                    ?>
                <div class="msg center"><br/><h3><?php echo __('no_data_found') ?></h3></div>
                    <?php
                } else {
                    ?>
                    ...
                    <table class="list footable table table-striped dynamicTable tableTools table-bordered  table-white table-primary" id="key_list" >
                        <thead>
                            ...
                            <tr>
                                <th><?php echo $appCommon->show_order('request_time', __('Time', true)) ?></th>
                                ...
                                <th class="last"><?php echo $appCommon->show_order('acd', __('Acd', true)) ?></th>
                            </tr>
                        </thead>
                        <tbody>
