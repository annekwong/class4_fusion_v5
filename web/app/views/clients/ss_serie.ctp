...
<div id="title">
        <h1><?php __('请选择 帐号池')?></h1>
</div>
<div class="container">
                
<ul class="tabs">
    <li class="active"><a href="">
    <img src="<?php echo $this->webroot?>images/menuIcon.gif" height="16" width="16"/> <?php __('帐号池')?></a></li>      
</ul>
...
<thead>
<tr>
 <td width="10%"><?php __('帐号池')?><?php echo __('id',true);?></td>
    <td width="40%"><?php __('帐号池名称')?></td>
