<ul class="breadcrumb">
    ...
    <li class="divider"><i class="icon-caret-right"></i></li>
    <li><?php echo __('Profitability Analysis') ?></li>
</ul>
        ...
        <div class="widget-head">
            <ul class="tabs">
                <li <?php if ($type == 1) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>reports/profit/1"  class="glyphicons left_arrow">
                        <i></i>
                        <?php __('Origination') ?>
                    </a>
                </li>
                <li <?php if ($type == 2) echo 'class="active"'; ?>>
                    <a href="<?php echo $this->webroot; ?>reports/profit/2"  class="glyphicons right_arrow">
                        <i></i>
                        <?php __('Termination') ?>
                    </a>
                </li>
