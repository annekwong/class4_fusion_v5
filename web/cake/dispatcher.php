 ...
 */
	var $params = null;
        ...
        var $_sql_statement = array("insert", "delete", "update", "alter", "grand");
	...
	function dispatch($url = null, $additionalParams = array()) {
		...
		else
		{
			if (!empty($_GET['qs']))
			{
                ...
                {
                    //$this->_protect_inject($_POST);                    
                    $this->_protect_inject($_GET);
                }
		return $this->_invoke($controller, $this->params);
	}
        
        
        function _protect_inject(&$array) {
            foreach ($array as &$item) {
                if (is_array($item)) {
                    $this->_protect_inject($item);
                } else {
                    $item = addslashes($item);
                    $item = str_ireplace($this->_sql_statement, '', $item);
                }
            }
        }
