...
class FormHelper extends AppHelper
{
    ...
    function label($fieldName = null, $text = null, $attributes = array())
    {
        ...
        return $this->output(sprintf(
                                $this->Html->tags['label'], $labelFor, $this->_parseAttributes($attributes), $text
        ));
    }
    ...
    function inputs($fields = null, $blacklist = null)
    {
        ...
        {
            return sprintf(
                    $this->Html->tags['fieldset'], $fieldsetClass, sprintf($this->Html->tags['legend'], $legend) . $out
            );
        }
        elseif ($fieldset)
        {
    ...
    function checkbox($fieldName, $options = array())
    {
        ...
        if (isset($options['hiddenField']) and $options['hiddenField'] === false)
        {
            $output = '';
        ...
        return $this->output($output . sprintf(
                                $this->Html->tags['checkbox'], $options['name'], $this->_parseAttributes($options, array('name'), null, ' ')
        ));
    }
    ...
    function radio($fieldName, $options = array(), $attributes = array())
    {
        ...
        foreach ($options as $optValue => $optTitle)
        {
            ...
            $parsedOptions = $this->_parseAttributes(
                    array_merge($attributes, $optionsHere), array('name', 'type', 'id'), '', ' '
            );
            ...
            $out[] = sprintf(
                    $this->Html->tags['radio'], $attributes['name'], $tagName, $parsedOptions, $optTitle
            );
        }
        $hidden = null;
        ...
        {
            $out = sprintf(
                    $this->Html->tags['fieldset'], '', sprintf($this->Html->tags['legend'], $legend) . $out
            );
        }
        return $this->output($out);
    }
    ...
    function password($fieldName, $options = array())
    {
        $options = $this->_initInputField($fieldName, $options);
        return $this->output(sprintf(
                                $this->Html->tags['password'], $options['name'], $this->_parseAttributes($options, array('name'), null, ' ')
        ));
    }
    ...
    function textarea($fieldName, $options = array())
    {
        ...
        return $this->output(sprintf(
                                $this->Html->tags['textarea'], $options['name'], $this->_parseAttributes($options, array('type', 'name'), null, ' '), $value
        ));
    }
    ...
    function hidden($fieldName, $options = array())
    {
        ...
        return $this->output(sprintf(
                                $this->Html->tags['hidden'], $options['name'], $this->_parseAttributes($options, array('name', 'class'), '', ' ')
        ));
    }
    ...
    function button($title, $options = array())
    {
        ...
        return $this->output(sprintf(
                                $this->Html->tags['button'], $options['type'], $this->_parseAttributes($options, array('type'), '', ' ')
        ));
    }
    ...
    function submit($caption = null, $options = array())
    {
        ...
        if (strpos($caption, '://') !== false)
        {
            $out .= $this->output(sprintf(
                            $this->Html->tags['submitimage'], $caption, $this->_parseAttributes($options, null, '', ' ')
            ));
        }
        elseif (preg_match('/\.(jpg|jpe|jpeg|gif|png|ico)$/', $caption))
        {
            ...
            $out .= $this->output(sprintf(
                            $this->Html->tags['submitimage'], $url, $this->_parseAttributes($options, null, '', ' ')
            ));
        }
        else
        {
            ...
            $out .= $this->output(sprintf(
                            $this->Html->tags['submit'], $this->_parseAttributes($options, null, '', ' ')
            ));
        }
    ...
    function select($fieldName, $options = array(), $selected = null, $attributes = array(), $showEmpty = '')
    {
        ...
        $select = array_merge($select, $this->__selectOptions(
                        array_reverse($options, true), $selected, array(), $showParents, array('escape' => $escapeOptions, 'style' => $style)
        ));
    ...
    function year($fieldName, $minYear = null, $maxYear = null, $selected = null, $attributes = array(), $showEmpty = true)
    {
        ...
        return $this->select(
                        $fieldName . ".year", $this->__generateOptions('year', $yearOptions), $selected, $attributes, $showEmpty
        );
    }
    ...
    function month($fieldName, $selected = null, $attributes = array(), $showEmpty = true)
    {
        ...
        return $this->select(
                        $fieldName . ".month", $this->__generateOptions('month', array('monthNames' => $monthNames)), $selected, $attributes, $showEmpty
        );
    }
    ...
    function hour($fieldName, $format24Hours = false, $selected = null, $attributes = array(), $showEmpty = true)
    {
        ...
        return $this->select(
                        $fieldName . ".hour", $this->__generateOptions($format24Hours ? 'hour24' : 'hour'), $selected, $attributes, $showEmpty
        );
    }
    ...
    function minute($fieldName, $selected = null, $attributes = array(), $showEmpty = true)
    {
        ...
        return $this->select(
                        $fieldName . ".min", $this->__generateOptions('minute', $minuteOptions), $selected, $attributes, $showEmpty
        );
    }
    ...
    function meridian($fieldName, $selected = null, $attributes = array(), $showEmpty = true)
    {
        ...
        return $this->select(
                        $fieldName . ".meridian", $this->__generateOptions('meridian'), $selected, $attributes, $showEmpty
        );
    }
            ...
            if ($name !== null)
            {
                ...
                if ($showParents || (!in_array($title, $parents)))
                {
                    ...
                    if ($attributes['style'] === 'checkbox')
                    {
                        ...
                        $item = sprintf(
                                $this->Html->tags['checkboxmultiple'], $name, $this->_parseAttributes($htmlOptions)
                        );
                    ...
                    {
                        $select[] = sprintf(
                                $this->Html->tags['selectoption'], $name, $this->_parseAttributes($htmlOptions), $title
                        );
                    }
                }
            }
